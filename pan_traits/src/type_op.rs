...
use pan_infer::infer::at::ToTrace;
use pan_infer::infer::canonical::{Canonical, QueryResponse};
use pan_infer::infer::{InferCtxt, TyCtxtInferExt};
use pan_infer::traits::TraitEngineExt as _;
use pan_middle::ty::query::Providers;
use pan_middle::ty::subst::{GenericArg, Subst, UserSelfTy, UserSubsts};
use pan_middle::ty::{self, FnSig, Lift, PolyFnSig, Ty, TyCtxt, TypeFoldable, Variance};
use pan_middle::ty::{ParamEnv, ParamEnvAnd, Predicate, ToPredicate};
use pan_span::DUMMY_SP;
use pan_trait_selection::infer::InferCtxtBuilderExt;
use pan_trait_selection::infer::InferCtxtExt;
use pan_trait_selection::traits::query::normalize::AtExt;
use pan_trait_selection::traits::query::type_op::ascribe_user_type::AscribeUserType;
use pan_trait_selection::traits::query::type_op::eq::Eq;
use pan_trait_selection::traits::query::type_op::normalize::Normalize;
use pan_trait_selection::traits::query::type_op::prove_predicate::ProvePredicate;
use pan_trait_selection::traits::query::type_op::subtype::Subtype;
use pan_trait_selection::traits::query::{Fallible, NoSolution};
use pan_trait_selection::traits::{Normalized, Obligation, ObligationCause, TraitEngine};
use std::fmt;
