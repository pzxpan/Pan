...
use pan_middle::infer::canonical::{CanonicalTyVarKind, CanonicalVarKind};
use pan_middle::traits::ChalkRustInterner;
use pan_middle::ty::query::Providers;
use pan_middle::ty::subst::GenericArg;
use pan_middle::ty::{self, BoundVar, ParamTy, TyCtxt, TypeFoldable};

use pan_infer::infer::canonical::{
    Canonical, CanonicalVarValues, Certainty, QueryRegionConstraints, QueryResponse,
};
use pan_infer::traits::{self, CanonicalChalkEnvironmentAndGoal};
