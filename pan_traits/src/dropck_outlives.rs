...
use pan_infer::infer::TyCtxtInferExt;
use pan_infer::traits::TraitEngineExt as _;
use pan_middle::ty::query::Providers;
use pan_middle::ty::subst::{InternalSubsts, Subst};
use pan_middle::ty::{self, ParamEnvAnd, Ty, TyCtxt};
use pan_span::source_map::{Span, DUMMY_SP};
use pan_trait_selection::traits::query::dropck_outlives::trivial_dropck_outlives;
use pan_trait_selection::traits::query::dropck_outlives::{
    DropckOutlivesResult, DtorckConstraint,
};
use pan_trait_selection::traits::query::normalize::AtExt;
use pan_trait_selection::traits::query::{CanonicalTyGoal, NoSolution};
...
fn dtorck_constraint_for_ty<'tcx>(
    ...
    match ty.kind() {
        ...
        ty::Tuple(tys) => pan_data_structures::stack::ensure_sufficient_stack(|| {
            for ty in tys.iter() {
