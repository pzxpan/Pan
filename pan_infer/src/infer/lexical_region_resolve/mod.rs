...
use pan_data_structures::graph::implementation::{
    Direction, Graph, NodeIndex, INCOMING, OUTGOING,
};
use pan_index::vec::{Idx, IndexVec};
use pan_middle::ty::fold::TypeFoldable;
use pan_middle::ty::{self, Ty, TyCtxt};
use pan_middle::ty::{ReEarlyBound, ReEmpty, ReErased, ReFree, ReStatic};
use pan_middle::ty::{ReLateBound, RePlaceholder, ReVar};
use pan_middle::ty::{Region, RegionVid};
use pan_span::Span;
use std::fmt;
