...
use pan_hir::intravisit::{walk_ty, ErasedMap, NestedVisitorMap, Visitor};
use pan_hir::{
    self as hir, GenericBound, ImplItem, Item, ItemKind, Lifetime, LifetimeName, Node, TraitItem,
    TyKind,
};
use pan_middle::ty::{self, AssocItemContainer, RegionKind, Ty, TypeFoldable, TypeVisitor};
...
impl<'a, 'tcx> NiceRegionError<'a, 'tcx> {
    ...
    pub(super) fn try_report_static_impl_trait(&self) -> Option<ErrorReported> {
        ...
        if let (Some(ident), true) = (override_error_code, fn_returns.is_empty()) {
            ...
            err.code(pan_errors::error_code!(E0772));
