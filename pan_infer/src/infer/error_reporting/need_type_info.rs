...
use pan_errors::{pluralize, struct_span_err, Applicability, DiagnosticBuilder};
use pan_hir as hir;
use pan_hir::def::{DefKind, Namespace};
use pan_hir::intravisit::{self, NestedVisitorMap, Visitor};
use pan_hir::{Body, Expr, ExprKind, FnRetTy, HirId, Local, Pat};
use pan_middle::hir::map::Map;
use pan_middle::infer::unify_key::ConstVariableOriginKind;
use pan_middle::ty::print::Print;
use pan_middle::ty::subst::{GenericArg, GenericArgKind};
use pan_middle::ty::{self, DefIdTree, InferConst, Ty};
use pan_span::source_map::DesugaringKind;
use pan_span::symbol::kw;
use pan_span::Span;
use std::borrow::Cow;
...
impl Into<pan_errors::DiagnosticId> for TypeAnnotationNeeded {
    fn into(self) -> pan_errors::DiagnosticId {
        match self {
            Self::E0282 => pan_errors::error_code!(E0282),
            Self::E0283 => pan_errors::error_code!(E0283),
            Self::E0284 => pan_errors::error_code!(E0284),
        }
    }
}
