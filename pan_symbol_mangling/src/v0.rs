use pan_ast::{FloatTy, IntTy, UintTy};
...
use pan_middle::ty::print::{Print, Printer};
use pan_middle::ty::subst::{GenericArg, GenericArgKind, Subst};
...
struct BinderLevel {
    ...
    /// This is used to flatten pan's pairing of `BrAnon`
