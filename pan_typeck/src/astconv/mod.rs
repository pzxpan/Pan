...
use pan_errors::{struct_span_err, Applicability, ErrorReported, FatalError};
use pan_hir as hir;
use pan_hir::def::{CtorOf, DefKind, Namespace, Res};
use pan_hir::def_id::{DefId, LocalDefId};
use pan_hir::intravisit::{walk_generics, Visitor as _};
use pan_hir::lang_items::LangItem;
use pan_hir::{Constness, GenericArg, GenericArgs};
use pan_middle::ty::subst::{self, InternalSubsts, Subst, SubstsRef};
use pan_middle::ty::GenericParamDefKind;
use pan_middle::ty::{self, Const, DefIdTree, Ty, TyCtxt, TypeFoldable};
use pan_session::lint::builtin::AMBIGUOUS_ASSOCIATED_ITEMS;
...
use pan_trait_selection::traits::astconv_object_safety_violations;
use pan_trait_selection::traits::error_reporting::report_object_safety_error;
use pan_trait_selection::traits::wf::object_region_bounds;
...
impl<'o, 'tcx> dyn AstConv<'tcx> + 'o {
    ...
    fn validate_late_bound_regions(
        ...
        generate_err: impl Fn(&str) -> pan_errors::DiagnosticBuilder<'tcx>,
    ) {
