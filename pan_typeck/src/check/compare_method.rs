...
use pan_errors::{pluralize, struct_span_err, Applicability, DiagnosticId, ErrorReported};
use pan_hir as hir;
use pan_hir::def::{DefKind, Res};
use pan_hir::intravisit;
use pan_hir::{GenericParamKind, ImplItemKind, TraitItemKind};
use pan_infer::infer::{self, InferOk, TyCtxtInferExt};
use pan_infer::traits::util;
use pan_middle::ty;
use pan_middle::ty::error::{ExpectedFound, TypeError};
use pan_middle::ty::subst::{InternalSubsts, Subst};
use pan_middle::ty::util::ExplicitSelf;
use pan_middle::ty::{GenericParamDefKind, ToPredicate, TyCtxt};
use pan_span::Span;
use pan_trait_selection::traits::error_reporting::InferCtxtExt;
use pan_trait_selection::traits::{self, ObligationCause, ObligationCauseCode, Reveal};
