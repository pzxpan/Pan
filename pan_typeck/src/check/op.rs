...
use super::FnCtxt;
use pan_ast as ast;
use pan_errors::{self, struct_span_err, Applicability, DiagnosticBuilder};
use pan_hir as hir;
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn add_type_neq_err_label(
        &self,
        err: &mut pan_errors::DiagnosticBuilder<'_>,
        span: Span,
        ty: Ty<'tcx>,
        other_ty: Ty<'tcx>,
        op: hir::BinOp,
