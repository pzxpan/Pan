...
use pan_hir::intravisit as hir_visit;
use pan_hir::intravisit::Visitor;
use pan_hir::itemlikevisit::ParItemLikeVisitor;
use pan_hir::lang_items::LangItem;
use pan_hir::ItemKind;
use pan_middle::hir::map as hir_map;
use pan_middle::ty::subst::{GenericArgKind, InternalSubsts, Subst};
use pan_middle::ty::trait_def::TraitSpecializationKind;
use pan_middle::ty::{
...
use pan_span::Span;
use pan_trait_selection::opaque_types::may_define_opaque_type;
