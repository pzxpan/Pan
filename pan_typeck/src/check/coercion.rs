...
use pan_infer::infer::{Coercion, InferOk, InferResult};
use pan_middle::ty::adjustment::{
    Adjust, Adjustment, AllowTwoPhase, AutoBorrow, AutoBorrowMutability, PointerCast,
};
use pan_middle::ty::error::TypeError;
use pan_middle::ty::fold::TypeFoldable;
use pan_middle::ty::relate::RelateResult;
use pan_middle::ty::subst::SubstsRef;
use pan_middle::ty::{self, Ty, TypeAndMut};
use pan_session::parse::feature_err;
use pan_span::symbol::sym;
use pan_span::{self, BytePos, Span};
use pan_target::spec::abi::Abi;
use pan_trait_selection::traits::error_reporting::InferCtxtExt;
use pan_trait_selection::traits::{self, ObligationCause, ObligationCauseCode};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    pub fn can_coerce(&self, expr_ty: Ty<'tcx>, target: Ty<'tcx>) -> bool {
        ...
        let cause = self.cause(pan_span::DUMMY_SP, ObligationCauseCode::ExprAssignable);
    ...
    pub fn deref_steps(&self, expr_ty: Ty<'tcx>, target: Ty<'tcx>) -> Option<usize> {
        ...
        let coerce = Coerce::new(self, cause, AllowTwoPhase::No);
        coerce
            .autoderef(pan_span::DUMMY_SP, expr_ty)
