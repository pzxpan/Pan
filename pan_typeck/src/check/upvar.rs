...
use pan_infer::infer::UpvarRegion;
use pan_middle::hir::place::{Place, PlaceBase, PlaceWithHirId, ProjectionKind};
use pan_middle::ty::{self, Ty, TyCtxt, UpvarSubsts};
use pan_span::sym;
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    fn log_capture_analysis_first_pass(
        &self,
        closure_def_id: pan_hir::def_id::DefId,
