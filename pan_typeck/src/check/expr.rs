...
use pan_errors::{pluralize, struct_span_err, Applicability, DiagnosticBuilder, DiagnosticId};
use pan_hir as hir;
use pan_hir::def::{CtorKind, DefKind, Res};
use pan_hir::def_id::DefId;
use pan_hir::lang_items::LangItem;
use pan_hir::{ExprKind, QPath};
use pan_infer::infer;
use pan_infer::infer::type_variable::{TypeVariableOrigin, TypeVariableOriginKind};
use pan_middle::ty;
use pan_middle::ty::adjustment::{Adjust, Adjustment, AllowTwoPhase};
use pan_middle::ty::Ty;
use pan_middle::ty::TypeFoldable;
use pan_middle::ty::{AdtKind, Visibility};
use pan_span::edition::LATEST_STABLE_EDITION;
use pan_span::hygiene::DesugaringKind;
use pan_span::lev_distance::find_best_match_for_name;
use pan_span::source_map::Span;
