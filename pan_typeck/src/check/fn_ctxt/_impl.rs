...
use pan_errors::{Applicability, DiagnosticBuilder, ErrorReported};
use pan_hir as hir;
use pan_hir::def::{CtorOf, DefKind, Res};
use pan_hir::def_id::DefId;
use pan_hir::lang_items::LangItem;
use pan_hir::{ExprKind, GenericArg, Node, QPath};
use pan_infer::infer::canonical::{Canonical, OriginalQueryValues, QueryResponse};
use pan_infer::infer::error_reporting::TypeAnnotationNeeded::E0282;
use pan_infer::infer::{InferOk, InferResult};
use pan_middle::ty::adjustment::{Adjust, Adjustment, AutoBorrow, AutoBorrowMutability};
use pan_middle::ty::fold::TypeFoldable;
use pan_middle::ty::subst::{
...
use pan_span::hygiene::DesugaringKind;
use pan_span::source_map::{original_sp, DUMMY_SP};
use pan_span::symbol::{kw, sym, Ident};
use pan_span::{self, BytePos, MultiSpan, Span};
use pan_trait_selection::infer::InferCtxtExt as _;
use pan_trait_selection::opaque_types::InferCtxtExt as _;
use pan_trait_selection::traits::error_reporting::InferCtxtExt as _;
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    pub(in super::super) fn fallback_if_possible(&self, ty: Ty<'tcx>, mode: FallbackMode) -> bool {
        use pan_middle::ty::error::UnconstrainedNumeric::Neither;
        use pan_middle::ty::error::UnconstrainedNumeric::{UnconstrainedFloat, UnconstrainedInt};
        ...
        self.demand_eqtype(pan_span::DUMMY_SP, ty, fallback);
        true
    }
    ...
    pub fn resolve_ty_and_res_ufcs<'b>(
        ...
        println!("resolve_ty_and_res_ufcs: qpath={:?} hir_id={:?} span={:?}", qpath, hir_id, span);
