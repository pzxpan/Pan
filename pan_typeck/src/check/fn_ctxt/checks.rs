...
use pan_ast as ast;
use pan_errors::{Applicability, DiagnosticBuilder, DiagnosticId};
use pan_hir as hir;
...
use pan_trait_selection::traits::{self, ObligationCauseCode, StatementAsExpression};
...
impl<'a, 'tcx> FnCtxt<'a, 'tcx> {
    ...
    /// ```
    fn get_expr_coercion_span(&self, expr: &hir::Expr<'_>) -> pan_span::Span {
