...
use pan_hir as hir;
use pan_hir::def_id::{DefIdMap, LocalDefId};
use pan_hir::HirIdMap;
use pan_infer::infer;
use pan_infer::infer::{InferCtxt, InferOk, TyCtxtInferExt};
...
use pan_trait_selection::opaque_types::OpaqueTypeDecl;
use pan_trait_selection::traits::{self, TraitEngine, TraitEngineExt};
