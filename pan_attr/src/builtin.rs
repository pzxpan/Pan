...
use pan_ast::{self as ast, Attribute, Lit, LitKind, MetaItem, MetaItemKind, NestedMetaItem};
use pan_ast_pretty::pprust;
use pan_errors::{struct_span_err, Applicability};
use pan_feature::{find_gated_cfg, is_builtin_attr_name, Features, GatedCfg};
...
use pan_span::{symbol::sym, symbol::Symbol, Span};
                ...
                sym::rustc_const_unstable | sym::unstable => {
                    ...
                    match (feature, reason, issue) {
                        (Some(feature), reason, Some(_)) => {
                            if !pan_lexer::is_ident(&feature.as_str()) {
                                handle_errors(
                                    &sess.parse_sess,
                                    attr.span,
                                    AttrError::NonIdentFeature,
