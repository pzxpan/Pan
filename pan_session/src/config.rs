...
use pan_data_structures::impl_stable_hash_via_hash;
use pan_data_structures::stable_hasher::{HashStable, StableHasher};

use pan_target::abi::{Align, TargetDataLayout};
use pan_target::spec::{Target, TargetTriple};

use crate::parse::CrateConfig;
use pan_feature::UnstableFeatures;
use pan_span::edition::{Edition, DEFAULT_EDITION, EDITION_NAME_LIST};
use pan_span::source_map::{FileName, FilePathMapping};
use pan_span::symbol::{sym, Symbol};
use pan_span::SourceFileHashAlgorithm;

use pan_errors::emitter::HumanReadableErrorType;
use pan_errors::{ColorConfig, HandlerFlags};
...
crate mod dep_tracking {
    ...
    use pan_target::spec::{CodeModel, MergeFunctions, PanicStrategy, RelocModel};
    use pan_target::spec::{RelroLevel, TargetTriple, TlsModel};
