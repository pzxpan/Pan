...
use pan_ast::node_id::NodeId;
use pan_data_structures::fx::{FxHashMap, FxHashSet};
use pan_data_structures::sync::{Lock, Lrc};
use pan_errors::{emitter::SilentEmitter, ColorConfig, Handler};
use pan_errors::{error_code, Applicability, DiagnosticBuilder};
use pan_feature::{find_feature_issue, GateIssue, UnstableFeatures};
use pan_span::edition::Edition;
use pan_span::hygiene::ExpnId;
use pan_span::source_map::{FilePathMapping, SourceMap};
use pan_span::{MultiSpan, Span, Symbol};
