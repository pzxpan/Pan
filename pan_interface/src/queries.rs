...
pub struct Queries<'tcx> {
    ...
    hir_arena: WorkerLocal<pan_ast_lowering::Arena<'tcx>>,
...
impl<'tcx> Queries<'tcx> {
    pub fn new(compiler: &'tcx Compiler) -> Queries<'tcx> {
        Queries {
            ...
            hir_arena: WorkerLocal::new(|_| pan_ast_lowering::Arena::default()),
    ...
    pub fn dep_graph_future(&self) -> Result<&Query<Option<DepGraphFuture>>> {
        self.dep_graph_future.compute(|| {
            Ok(self
                ...
                .opts
                .build_dep_graph()
                .then(|| pan_incremental::load_dep_graph(self.session())))
        })
    }
...
impl Linker {
    pub fn link(self) -> Result<()> {
        ...
        sess.time("serialize_work_products", || {
            pan_incremental::save_work_product_index(&sess, &dep_graph, work_products)
        });
        ...
        pan_incremental::finalize_session_directory(&self.sess, self.crate_hash);
