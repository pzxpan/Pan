...
use pan_ast::{self as ast, visit};
use pan_codegen_ssa::back::link::emit_metadata;
use pan_codegen_ssa::traits::CodegenBackend;
use pan_data_structures::steal::Steal;
use pan_data_structures::sync::{par_iter, Lrc, OnceCell, ParallelIterator, WorkerLocal};
use pan_data_structures::temp_dir::MaybeTempDir;
use pan_data_structures::{box_region_allow_access, declare_box_region_type, parallel};
use pan_errors::{ErrorReported, PResult};
use pan_expand::base::ExtCtxt;
use pan_hir::def_id::{CrateNum, LOCAL_CRATE};
use pan_hir::definitions::Definitions;
use pan_hir::Crate;
use pan_lint::LintStore;
use pan_middle::arena::Arena;
use pan_middle::dep_graph::DepGraph;
use pan_middle::middle;
use pan_middle::middle::cstore::{CrateStore, MetadataLoader, MetadataLoaderDyn};
use pan_middle::ty::query::Providers;
use pan_middle::ty::{self, GlobalCtxt, ResolverOutputs, TyCtxt};
use pan_mir as mir;
use pan_mir_build as mir_build;
use pan_parse::{parse_crate_from_file, parse_crate_from_source_str};
use pan_passes::{self, hir_stats, layout_test};
use pan_plugin_impl as plugin;
use pan_resolve::{Resolver, ResolverArenas};
