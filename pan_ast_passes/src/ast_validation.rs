...
use pan_errors::{error_code, pluralize, struct_span_err, Applicability};
use pan_parse::validate_attr;
use pan_session::lint::builtin::PATTERNS_IN_FNS_WITHOUT_BODY;
use pan_session::lint::LintBuffer;
...
impl<'a> AstValidator<'a> {
    ...
    fn err_handler(&self) -> &pan_errors::Handler {
    ...
    fn check_decl_attrs(&self, fn_decl: &FnDecl) {
        fn_decl
            ...
            .filter(|attr| {
                ...
                !arr.contains(&attr.name_or_empty()) && pan_attr::is_builtin_attr(attr)
            })
            .for_each(|attr| {
                            ...
                            match &full_path.segments[qself.position..] {
                                [PathSegment { ident, args, .. }] => {
                                    ...
                                    let arg = AngleBracketedArg::Constraint(AssocTyConstraint {
                                        id: pan_ast::node_id::DUMMY_NODE_ID,
                                        ident: *ident,
                                        gen_args,
