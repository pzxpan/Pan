...
use {
    ...
    pan_data_structures::fx::FxHashSet,
    pan_data_structures::stable_hasher::{HashStable, StableHasher},
    pan_data_structures::sync::Lock,
    pan_data_structures::sync::Lrc,
    pan_data_structures::{jobserver, OnDrop},
