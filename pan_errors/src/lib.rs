...
use pan_data_structures::fx::{FxHashSet, FxIndexMap};
use pan_data_structures::stable_hasher::StableHasher;
use pan_data_structures::sync::{self, Lock, Lrc};
use pan_data_structures::AtomicRef;
use pan_lint_defs::FutureBreakage;
pub use pan_lint_defs::{pluralize, Applicability};
use pan_span::source_map::SourceMap;
use pan_span::{Loc, MultiSpan, Span};
...
pan_data_structures::static_assert_size!(PResult<'_, bool>, 16);
...
pub use pan_span::fatal_error::{FatalError, FatalErrorMarker};
...
pan_data_structures::impl_stable_hash_via_hash!(ErrorReported);
