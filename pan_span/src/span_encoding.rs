...
// The encoding format for inline spans were obtained by optimizing over crates in pan/libstd.
...
///   the code. No crates in `pan-perf` need more than 15 bits for `ctxt`,
