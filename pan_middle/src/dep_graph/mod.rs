...
use pan_data_structures::sync::Lock;
...
pub(crate) use pan_query_system::dep_graph::DepNodeParams;
pub use pan_query_system::dep_graph::{
...
pub type DepGraph = pan_query_system::dep_graph::DepGraph<DepKind>;
pub type TaskDeps = pan_query_system::dep_graph::TaskDeps<DepKind>;
pub type DepGraphQuery = pan_query_system::dep_graph::DepGraphQuery<DepKind>;
pub type PreviousDepGraph = pan_query_system::dep_graph::PreviousDepGraph<DepKind>;
pub type SerializedDepGraph = pan_query_system::dep_graph::SerializedDepGraph<DepKind>;

impl pan_query_system::dep_graph::DepKind for DepKind {
