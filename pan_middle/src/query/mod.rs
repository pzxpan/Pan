...
use pan_query_system::query::QueryDescription;
...
rustc_queries! {
    ...
    Other {
        ...
        query expn_that_defined(key: DefId) -> pan_span::ExpnId {
    ...
    Other {
        ...
        query const_caller_location(key: (pan_span::Symbol, u32, u32)) -> ConstValue<'tcx> {
    ...
    Other {
        query fn_arg_names(def_id: DefId) -> &'tcx [pan_span::symbol::Ident] {
    ...
    TypeChecking {
        ...
        ) -> Result<&'tcx pan_target::abi::Layout, ty::layout::LayoutError<'tcx>> {
    ...
    Other {
        ...
        query features_query(_: CrateNum) -> &'tcx pan_feature::Features {
            eval_always
