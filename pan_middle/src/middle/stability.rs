...
use pan_ast::NodeId;
use pan_attr::{self as attr, ConstStability, Deprecation, Stability};
use pan_data_structures::fx::{FxHashMap, FxHashSet};
use pan_errors::{Applicability, DiagnosticBuilder};
use pan_feature::GateIssue;
use pan_hir as hir;
use pan_hir::def::DefKind;
use pan_hir::def_id::{CrateNum, DefId, CRATE_DEF_INDEX};
use pan_hir::{self, HirId};
use pan_middle::ty::print::with_no_trimmed_paths;
use pan_session::lint::builtin::{DEPRECATED, DEPRECATED_IN_FUTURE, SOFT_UNSTABLE};
use pan_session::lint::{BuiltinLintDiagnostics, Lint, LintBuffer};
use pan_session::parse::feature_err_issue;
use pan_session::{DiagnosticMessageId, Session};
use pan_span::symbol::{sym, Symbol};
use pan_span::{MultiSpan, Span};
