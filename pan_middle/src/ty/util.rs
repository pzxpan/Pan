...
use pan_apfloat::Float as _;
use pan_ast as ast;
use pan_attr::{self as attr, SignedInt, UnsignedInt};
...
use pan_target::abi::{Integer, Size, TargetDataLayout};
    ...
    pub fn numeric_max_val(&'tcx self, tcx: TyCtxt<'tcx>) -> Option<&'tcx ty::Const<'tcx>> {
        let val = match self.kind() {
            ...
            ty::Float(fty) => Some(match fty {
                ast::FloatTy::F32 => pan_apfloat::ieee::Single::INFINITY.to_bits(),
                ast::FloatTy::F64 => pan_apfloat::ieee::Double::INFINITY.to_bits(),
            }),
            _ => None,
        };
