...
use pan_ast as ast;
use pan_ast::expand::allocator::AllocatorKind;
use pan_attr as attr;
use pan_data_structures::fx::{FxHashMap, FxHashSet};
use pan_data_structures::profiling::SelfProfilerRef;
use pan_data_structures::sharded::{IntoPointer, ShardedHashMap};
use pan_data_structures::stable_hasher::{
    hash_stable_hashmap, HashStable, StableHasher, StableVec,
};
use pan_data_structures::steal::Steal;
use pan_data_structures::sync::{self, Lock, Lrc, WorkerLocal};
use pan_errors::ErrorReported;
use pan_hir as hir;
use pan_hir::def::{DefKind, Res};
use pan_hir::def_id::{CrateNum, DefId, DefIdMap, LocalDefId};
use pan_hir::def_id::{CRATE_DEF_INDEX, LOCAL_CRATE};
use pan_hir::definitions::Definitions;
use pan_hir::intravisit::Visitor;
use pan_hir::lang_items::LangItem;
use pan_hir::{
...
use pan_session::config::{BorrowckMode, CrateType, OutputFilenames};
use pan_session::lint::{Level, Lint};
use pan_session::Session;
use pan_span::source_map::MultiSpan;
use pan_span::symbol::{kw, sym, Symbol};
use pan_span::{Span, DUMMY_SP};
use pan_target::abi::{Layout, TargetDataLayout, VariantIdx};
use pan_target::spec::abi;
...
impl<'tcx> TyCtxt<'tcx> {
    ...
    pub fn lang_items(self) -> &'tcx pan_hir::lang_items::LanguageItems {
    ...
    pub fn features(self) -> &'tcx pan_feature::Features {
        self.features_query(LOCAL_CRATE)
    }

    pub fn def_key(self, id: DefId) -> pan_hir::definitions::DefKey {
    ...
    pub fn def_path(self, id: DefId) -> pan_hir::definitions::DefPath {
    ...
    #[inline]
    pub fn def_path_hash(self, def_id: DefId) -> pan_hir::definitions::DefPathHash {
    ...
    pub fn article_and_description(self, def_id: DefId) -> (&'static str, &'static str) {
        match self.def_kind(def_id) {
            DefKind::Generator => match self.generator_kind(def_id).unwrap() {
                pan_hir::GeneratorKind::Async(..) => ("an", "async closure"),
                pan_hir::GeneratorKind::Gen => ("a", "generator"),
            },
...
pub mod tls {
    ...
    use crate::ty::query;
    use pan_data_structures::sync::{self, Lock};
    use pan_data_structures::thin_vec::ThinVec;
    use pan_errors::Diagnostic;
    use std::mem;
    ...
    fn set_tlv<F: FnOnce() -> R, R>(value: usize, f: F) -> R {
        let old = get_tlv();
        let _reset = pan_data_structures::OnDrop(move || TLV.with(|tlv| tlv.set(old)));
