...
pub trait OpaqueEncoder: Encoder {
    fn opaque(&mut self) -> &mut pan_serialize::opaque::Encoder;
    fn encoder_position(&self) -> usize;
}

impl OpaqueEncoder for pan_serialize::opaque::Encoder {
    #[inline]
    fn opaque(&mut self) -> &mut pan_serialize::opaque::Encoder {
        self
    }
...
pan_hir::arena_types!(impl_arena_allocatable_decoders, [], 'tcx);
