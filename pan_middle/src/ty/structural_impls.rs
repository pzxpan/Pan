...
use pan_data_structures::functor::IdFunctor;
use pan_hir as hir;
...
TrivialTypeFoldableAndLiftImpls! {
    ...
    bool,
    usize,
    ::pan_target::abi::VariantIdx,
    u32,
    u64,
    String,
    crate::middle::region::Scope,
    ::pan_ast::FloatTy,
    ::pan_ast::InlineAsmOptions,
    ::pan_ast::InlineAsmTemplatePiece,
    ::pan_ast::NodeId,
    ::pan_span::symbol::Symbol,
    ::pan_hir::def::Res,
    ::pan_hir::def_id::DefId,
    ::pan_hir::def_id::LocalDefId,
    ::pan_hir::HirId,
    ::pan_hir::LlvmInlineAsmInner,
    ::pan_hir::MatchSource,
    ::pan_hir::Mutability,
    ::pan_hir::Unsafety,
    ::pan_target::asm::InlineAsmRegOrRegClass,
    ::pan_target::spec::abi::Abi,
