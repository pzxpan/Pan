...
use pan_query_system::query::QueryContext;
use pan_query_system::query::{CycleError, QueryJobId, QueryJobInfo};

use pan_data_structures::fx::FxHashMap;
use pan_data_structures::sync::Lock;
use pan_data_structures::thin_vec::ThinVec;
use pan_errors::{struct_span_err, Diagnostic, DiagnosticBuilder, Handler, Level};
    ...
    fn start_query<R>(
        ...
        tls::with_related_context(*self, move |current_icx| {
            ...
            tls::enter_context(&new_icx, |_| {
                pan_data_structures::stack::ensure_sufficient_stack(|| compute(*self))
            })
        })
    }
}
    ...
    (<$tcx:tt>
     $($(#[$attr:meta])*
        ...
        use crate::{
            ...
            pan_data_structures::stable_hasher::StableHasher,
