...
use pan_data_structures::fx::FxIndexMap;
use pan_data_structures::sorted_map::SortedIndexMultiMap;
use pan_data_structures::stable_hasher::{HashStable, StableHasher};
use pan_data_structures::sync::{self, par_iter, ParallelIterator};
use pan_data_structures::tagged_ptr::CopyTaggedPtr;
use pan_errors::ErrorReported;
use pan_hir as hir;
use pan_hir::def::{CtorKind, CtorOf, DefKind, Namespace, Res};
use pan_hir::def_id::{CrateNum, DefId, DefIdMap, LocalDefId, CRATE_DEF_INDEX};
use pan_hir::lang_items::LangItem;
use pan_hir::{Constness, Node};
use pan_index::vec::{Idx, IndexVec};
use pan_macros::HashStable;
use pan_serialize::{self, Encodable, Encoder};
use pan_session::DataTypeKind;
use pan_span::hygiene::ExpnId;
use pan_span::symbol::{kw, sym, Ident, Symbol};
use pan_span::Span;
use pan_target::abi::{Align, VariantIdx};
...
pub use pan_type_ir::{DebruijnIndex, TypeFlags, INNERMOST};
...
pub struct ResolverOutputs {
    pub definitions: pan_hir::definitions::Definitions,
...
unsafe impl pan_data_structures::tagged_ptr::Tag for traits::Reveal {
    const BITS: usize = 1;
    ...
    fn item_name_from_def_id(self, def_id: DefId) -> Option<Symbol> {
        if def_id.index == CRATE_DEF_INDEX {
            ...
            match def_key.disambiguated_data.data {
                ...
                pan_hir::definitions::DefPathData::Ctor => self.item_name_from_def_id(DefId {
                    krate: def_id.krate,
