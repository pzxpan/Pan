...
use pan_ast::{self as ast, IntTy, UintTy};
...
use pan_session::{DataTypeKind, FieldInfo, SizeKind, VariantInfo};
use pan_span::symbol::{Ident, Symbol};
use pan_span::DUMMY_SP;
use pan_target::abi::call::{
    ArgAbi, ArgAttribute, ArgAttributes, ArgExtension, Conv, FnAbi, PassMode, Reg, RegKind,
};
use pan_target::abi::*;
use pan_target::spec::{abi::Abi as SpecAbi, HasTargetSpec, PanicStrategy};
...
pub type TyAndLayout<'tcx> = pan_target::abi::TyAndLayout<'tcx, Ty<'tcx>>;
