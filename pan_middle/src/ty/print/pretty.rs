...
use pan_hir as hir;
use pan_hir::def::{self, CtorKind, DefKind, Namespace};
use pan_hir::def_id::{CrateNum, DefId, DefIdSet, CRATE_DEF_INDEX, LOCAL_CRATE};
use pan_hir::definitions::{DefPathData, DefPathDataName, DisambiguatedDefPathData};
use pan_hir::ItemKind;
use pan_session::config::TrimmedDefPaths;
use pan_span::symbol::{kw, Ident, Symbol};
use pan_target::abi::Size;
