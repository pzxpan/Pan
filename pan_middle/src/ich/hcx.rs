...
use pan_hir::definitions::{DefPathHash, Definitions};
use pan_session::Session;
use pan_span::source_map::SourceMap;
use pan_span::symbol::Symbol;
use pan_span::{BytePos, CachingSourceMapView, SourceFile};

use pan_span::def_id::{CrateNum, CRATE_DEF_INDEX};
...
impl<'a> pan_span::HashStableContext for StableHashingContext<'a> {
