...
use pan_data_structures::stable_hasher::{HashStable, StableHasher, ToStableHashKey};
use pan_hir as hir;
use pan_hir::def_id::{CrateNum, DefId, LocalDefId, CRATE_DEF_INDEX};
use pan_hir::definitions::DefPathHash;
use smallvec::SmallVec;
use std::mem;

impl<'ctx> pan_hir::HashStableContext for StableHashingContext<'ctx> {
    #[inline]
