...
use pan_span::hygiene::ExpnKind;
use pan_span::source_map::SourceMap;
use pan_span::symbol::{kw, sym};
use pan_span::symbol::{Ident, Symbol};
use pan_span::{self, edition::Edition, FileName, RealFileName, Span, DUMMY_SP};
use std::borrow::Cow;
use std::{fmt, mem};
...
pan_data_structures::static_assert_size!(TokenKind, 16);
...
#[cfg(target_arch = "x86_64")]
pan_data_structures::static_assert_size!(Nonterminal, 48);
