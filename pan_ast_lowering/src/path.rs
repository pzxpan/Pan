...
use pan_hir as hir;
use pan_hir::def::{DefKind, PartialRes, Res};
use pan_hir::def_id::DefId;
use pan_hir::GenericArg;
use pan_session::lint::builtin::ELIDED_LIFETIMES_IN_PATHS;
            ...
            if expected_lifetimes > 0 && param_mode == ParamMode::Explicit {
                ...
                match self.anonymous_lifetime_mode {
                    ...
                    AnonymousLifetimeMode::CreateParameter => {
                        ...
                        pan_errors::add_elided_lifetime_in_path_suggestion(
