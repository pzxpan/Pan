...
use pan_ast::token::{self, DelimToken, Nonterminal, Token};
use pan_ast::tokenstream::{CanSynthesizeMissingTokens, DelimSpan, TokenStream, TokenTree};
use pan_ast::visit::{self, AssocCtxt, Visitor};
use pan_ast::walk_list;
...
use pan_hir as hir;
use pan_hir::def::{DefKind, Namespace, PartialRes, PerNS, Res};
use pan_hir::def_id::{DefId, DefIdMap, LocalDefId, CRATE_DEF_INDEX};
use pan_hir::definitions::{DefKey, DefPathData, Definitions};
use pan_hir::intravisit;
use pan_hir::{ConstArg, GenericArg, ParamName};
use pan_index::vec::{Idx, IndexVec};
use pan_session::lint::{builtin::BARE_TRAIT_OBJECTS, BuiltinLintDiagnostics, LintBuffer};
use pan_session::parse::ParseSess;
use pan_session::Session;
use pan_span::hygiene::ExpnId;
use pan_span::source_map::{respan, DesugaringKind, ExpnData, ExpnKind};
...
pan_hir::arena_types!(pan_arena::declare_arena, [], 'tcx);
...
impl<'a, 'hir> LoweringContext<'a, 'hir> {
    ...
    fn diagnostic(&self) -> &pan_errors::Handler {
