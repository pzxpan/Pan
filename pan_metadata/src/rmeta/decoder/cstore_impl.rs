...
use pan_data_structures::stable_map::FxHashMap;
use pan_data_structures::svh::Svh;
use pan_hir as hir;
use pan_hir::def::DefKind;
use pan_hir::def_id::{CrateNum, DefId, DefIdMap, CRATE_DEF_INDEX, LOCAL_CRATE};
use pan_hir::definitions::{DefKey, DefPath, DefPathHash};
use pan_middle::hir::exports::Export;
use pan_middle::middle::cstore::ForeignModule;
use pan_middle::middle::cstore::{CrateSource, CrateStore, EncodedMetadata};
use pan_middle::middle::exported_symbols::ExportedSymbol;
use pan_middle::middle::stability::DeprecationEntry;
...
use pan_span::source_map::{Span, Spanned};
