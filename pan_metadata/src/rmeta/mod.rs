...
use pan_ast::{self as ast, MacroDef};
use pan_attr as attr;
use pan_data_structures::svh::Svh;
use pan_data_structures::sync::MetadataRef;
use pan_hir as hir;
use pan_hir::def::CtorKind;
use pan_hir::def_id::{DefId, DefIndex, DefPathHash};
use pan_hir::definitions::DefKey;
use pan_hir::lang_items;
use pan_index::{bit_set::FiniteBitSet, vec::IndexVec};
use pan_middle::hir::exports::Export;
use pan_middle::middle::cstore::{CrateDepKind, ForeignModule, LinkagePreference, NativeLib};
use pan_middle::middle::exported_symbols::{ExportedSymbol, SymbolExportLevel};
use pan_middle::mir;
use pan_middle::ty::{self, ReprOptions, Ty};
use pan_serialize::opaque::Encoder;
use pan_session::config::SymbolManglingVersion;
use pan_session::CrateDisambiguator;
use pan_span::edition::Edition;
use pan_span::hygiene::MacroKind;
use pan_span::symbol::{Ident, Symbol};
use pan_span::{self, ExpnData, ExpnId, Span};
use pan_target::spec::{PanicStrategy, TargetTriple};
...
use pan_span::hygiene::SyntaxContextData;
...
crate struct CrateRoot<'tcx> {
    ...
    source_map: Lazy<[pan_span::SourceFile]>,
