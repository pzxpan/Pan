...
use pan_hir::def_id::{CrateNum, LocalDefId, LOCAL_CRATE};
use pan_hir::definitions::Definitions;
use pan_index::vec::IndexVec;
use pan_middle::middle::cstore::{CrateDepKind, CrateSource, ExternCrate};
use pan_middle::middle::cstore::{ExternCrateSource, MetadataLoaderDyn};
use pan_middle::ty::TyCtxt;
use pan_session::config::{self, CrateType, ExternLocation};
use pan_session::lint;
use pan_session::output::validate_crate_name;
