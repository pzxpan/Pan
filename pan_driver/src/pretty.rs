...
use pan_hir_pretty as pprust_hir;
use pan_middle::hir::map as hir_map;
use pan_middle::ty::{self, TyCtxt};
use pan_mir::util::{write_mir_graphviz, write_mir_pretty};
use pan_session::config::{Input, PpMode, PpSourceMode};
use pan_session::Session;
use pan_span::symbol::Ident;
use pan_span::FileName;
    ...
    fn post(&self, s: &mut pprust::State<'_>, node: pprust::AnnNode<'_>) {
        match node {
            ...
            pprust::AnnNode::Crate(_) => {
                ...
                s.synth_comment(pan_span::hygiene::debug_hygiene_data(verbose));
