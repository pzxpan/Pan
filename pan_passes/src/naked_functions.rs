...
use pan_hir::intravisit::{ErasedMap, FnKind, NestedVisitorMap, Visitor};
use pan_hir::{ExprKind, HirId, InlineAsmOperand, StmtKind};
use pan_middle::ty::query::Providers;
use pan_middle::ty::TyCtxt;
use pan_session::lint::builtin::UNSUPPORTED_NAKED_FUNCTIONS;
