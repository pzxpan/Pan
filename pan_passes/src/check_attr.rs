...
use pan_ast::{Attribute, LitKind, NestedMetaItem};
use pan_errors::{pluralize, struct_span_err};
use pan_hir as hir;
...
use pan_hir::{MethodKind, Target};
use pan_session::lint::builtin::{CONFLICTING_REPR_HINTS, UNUSED_ATTRIBUTES};
...
impl CheckAttrVisitor<'tcx> {
    ...
    fn check_doc_keyword(&self, meta: &NestedMetaItem, hir_id: HirId) -> bool {
        ...
        if !pan_lexer::is_ident(&doc_keyword) {
            self.tcx
                .sess
                .struct_span_err(
                    meta.name_value_literal_span().unwrap_or_else(|| meta.span()),
            ...
            self.tcx.struct_span_lint_hir(
                ...
                |lint| {
                    lint.build("conflicting representation hints")
                        .code(pan_errors::error_code!(E0566))
                        .emit();
                },
            );
        }
