...
use pan_hir::def_id::{CrateNum, LocalDefId, CRATE_DEF_INDEX, LOCAL_CRATE};
use pan_hir::itemlikevisit::ItemLikeVisitor;
use pan_hir::{ForeignItem, HirId, ImplItem, Item, ItemKind, TraitItem};
use pan_middle::hir::map::Map;
use pan_middle::ty::query::Providers;
use pan_middle::ty::TyCtxt;
use pan_session::config::{CrateType, EntryFnType};
