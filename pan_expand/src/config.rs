...
use pan_ast::attr::HasAttrs;
use pan_ast::mut_visit::*;
use pan_ast::ptr::P;
use pan_ast::token::{DelimToken, Token, TokenKind};
use pan_ast::tokenstream::{DelimSpan, LazyTokenStream, Spacing, TokenStream, TokenTree};
use pan_ast::{self as ast, AttrItem, Attribute, MetaItem};
use pan_attr as attr;
use pan_data_structures::fx::FxHashMap;
use pan_data_structures::map_in_place::MapInPlace;
use pan_errors::{error_code, struct_span_err, Applicability, Handler};
use pan_feature::{Feature, Features, State as FeatureState};
use pan_feature::{
    ACCEPTED_FEATURES, ACTIVE_FEATURES, REMOVED_FEATURES, STABLE_REMOVED_FEATURES,
};
use pan_parse::{parse_in, validate_attr};
use pan_session::parse::feature_err;
use pan_session::Session;
use pan_span::edition::{Edition, ALL_EDITIONS};
