...
use pan_ast::mut_visit::*;
use pan_ast::ptr::P;
use pan_ast::token;
use pan_ast::tokenstream::TokenStream;
use pan_ast::visit::{self, AssocCtxt, Visitor};
use pan_ast::{self as ast, AttrItem, AttrStyle, Block, LitKind, NodeId, PatKind, Path};
use pan_ast::{ItemKind, MacArgs, MacCallStmt, MacStmtStyle, StmtKind, Unsafe};
use pan_ast_pretty::pprust;
use pan_attr::{self as attr, is_builtin_attr, HasAttrs};
use pan_data_structures::map_in_place::MapInPlace;
use pan_data_structures::stack::ensure_sufficient_stack;
use pan_errors::{struct_span_err, Applicability, PResult};
use pan_feature::Features;
use pan_parse::parser::{AttemptLocalParseRecovery, Parser};
use pan_parse::validate_attr;
use pan_session::lint::builtin::UNUSED_DOC_COMMENTS;
use pan_session::lint::BuiltinLintDiagnostics;
use pan_session::parse::{feature_err, ParseSess};
use pan_session::Limit;
use pan_span::symbol::{sym, Ident, Symbol};
use pan_span::{ExpnId, FileName, Span, DUMMY_SP};
            ...
            InvocationKind::Attr { attr, mut item, derives, after_derive } => match ext {
                SyntaxExtensionKind::Attr(expander) => {
                    ...
                    let tokens = match attr.style {
                        ...
                        AttrStyle::Inner => pan_parse::fake_token_stream(
...
impl<'a, 'b> InvocationCollector<'a, 'b> {
    ...
    fn check_attributes(&mut self, attrs: &[ast::Attribute]) {
        ...
        for attr in attrs.iter() {
            pan_ast_passes::feature_gate::check_attribute(attr, self.cx.sess, features);
