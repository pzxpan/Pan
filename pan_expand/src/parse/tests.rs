...
use pan_ast::visit;
use pan_ast::{self as ast, PatKind};
use pan_ast_pretty::pprust::item_to_string;
use pan_errors::PResult;
use pan_parse::new_parser_from_source_str;
use pan_session::parse::ParseSess;
use pan_span::source_map::FilePathMapping;
use pan_span::symbol::{kw, sym, Symbol};
use pan_span::with_default_session_globals;
use pan_span::{BytePos, FileName, Pos, Span};
