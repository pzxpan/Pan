...
use pan_ast as ast;
use pan_ast::token::{self, NonterminalKind, NtTT, Token, TokenKind::*};
use pan_ast::tokenstream::{DelimSpan, TokenStream};
use pan_ast_pretty::pprust;
use pan_attr::{self as attr, TransparencyError};
...
pub fn compile_declarative_macro(
    ...
    let parser = Parser::new(&sess.parse_sess, body, true, pan_parse::MACRO_ARGUMENTS);
...
fn parser_from_cx(sess: &ParseSess, tts: TokenStream) -> Parser<'_> {
    Parser::new(sess, tts, true, pan_parse::MACRO_ARGUMENTS)
}
