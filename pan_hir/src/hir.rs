...
use pan_ast::util::parser::ExprPrecedence;
use pan_ast::{self as ast, CrateSugar, LlvmAsmDialect};
use pan_ast::{AttrVec, Attribute, FloatTy, IntTy, Label, LitKind, StrStyle, UintTy};
pub use pan_ast::{BorrowKind, ImplPolarity, IsAuto};
pub use pan_ast::{CaptureBy, Movability, Mutability};
use pan_ast::{InlineAsmOptions, InlineAsmTemplatePiece};
use pan_data_structures::sync::{par_for_each_in, Send, Sync};
...
use pan_span::{MultiSpan, Span, DUMMY_SP};
...
pan_data_structures::static_assert_size!(Expr<'static>, 72);
