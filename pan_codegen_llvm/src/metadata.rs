...
use pan_target::spec::Target;

use pan_codegen_ssa::METADATA_FILENAME;
use pan_data_structures::owning_ref::OwningRef;
use pan_data_structures::rustc_erase_owner;
use tracing::debug;
...
pub use pan_data_structures::sync::MetadataRef;
...
pub fn metadata_section_name(target: &Target) -> &'static str {
    ...
    if target.is_like_osx { "__DATA,.pan" } else { ".pan" }
}
