...
use pan_codegen_ssa::base::{compare_simd_types, wants_msvc_seh};
use pan_codegen_ssa::common::span_invalid_monomorphization_error;
use pan_codegen_ssa::common::{IntPredicate, TypeKind};
use pan_codegen_ssa::mir::operand::OperandRef;
use pan_codegen_ssa::mir::place::PlaceRef;
use pan_codegen_ssa::traits::*;
use pan_hir as hir;
use pan_middle::ty::layout::{FnAbiExt, HasTyCtxt};
use pan_middle::ty::{self, Ty};
use pan_middle::{bug, span_bug};
use pan_span::{sym, symbol::kw, Span, Symbol};
use pan_target::abi::{self, HasDataLayout, LayoutOf, Primitive};
...
fn generic_simd_intrinsic(
    ...
    fn simd_simple_float_intrinsic(
        name: &str,
        in_elem: &::pan_middle::ty::TyS<'_>,
        in_ty: &::pan_middle::ty::TyS<'_>,
        in_len: u64,
        bx: &mut Builder<'a, 'll, 'tcx>,
        span: Span,
        args: &[OperandRef<'tcx, &'ll Value>],
