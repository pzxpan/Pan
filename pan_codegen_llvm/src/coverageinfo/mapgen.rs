...
use pan_codegen_ssa::coverageinfo::map::{Counter, CounterExpression, FunctionCoverage};
use pan_codegen_ssa::traits::ConstMethods;
use pan_data_structures::fx::{FxHashMap, FxHashSet, FxIndexSet};
use pan_hir::def_id::{DefId, DefIdSet, LOCAL_CRATE};
use pan_llvm::RustString;
use pan_middle::mir::coverage::CodeRegion;
use pan_middle::ty::{Instance, TyCtxt};
use pan_span::Symbol;
...
/// as defined at [LLVM Code Coverage Mapping Format](https://github.com/rust-lang/llvm-project/blob/pan/11.0-2020-10-12/llvm/docs/CoverageMappingFormat.rst#llvm-code-coverage-mapping-format)
...
pub fn finalize<'ll, 'tcx>(cx: &CodegenCx<'ll, 'tcx>) {
    ...
    if version != 3 {
        tcx.sess.fatal("pan option `-Z instrument-coverage` requires LLVM 11 or higher.");
    }
