...
use pan_codegen_ssa::back::lto::{LtoModuleCodegen, SerializedModule, ThinModule};
use pan_codegen_ssa::back::write::{
    CodegenContext, FatLTOInput, ModuleConfig, TargetMachineFactoryConfig, TargetMachineFactoryFn,
};
use pan_codegen_ssa::traits::*;
use pan_codegen_ssa::ModuleCodegen;
use pan_codegen_ssa::{CodegenResults, CompiledModule};
use pan_data_structures::fx::FxHashMap;
use pan_errors::{ErrorReported, FatalError, Handler};
use pan_middle::dep_graph::{WorkProduct, WorkProductId};
use pan_middle::middle::cstore::{EncodedMetadata, MetadataLoaderDyn};
use pan_middle::ty::{self, TyCtxt};
use pan_session::config::{OptLevel, OutputFilenames, PrintRequest};
...
impl CodegenBackend for LlvmCodegenBackend {
    ...
    fn codegen_crate<'tcx>(
        ...
        Box::new(pan_codegen_ssa::base::codegen_crate(
            LlvmCodegenBackend(()),
            tcx,
            metadata,
    ...
    fn join_codegen(
        ...
        let (codegen_results, work_products) = ongoing_codegen
            .downcast::<pan_codegen_ssa::back::write::OngoingCodegen<LlvmCodegenBackend>>()
    ...
    fn link(
        ...
        use pan_codegen_ssa::back::link::link_binary;
