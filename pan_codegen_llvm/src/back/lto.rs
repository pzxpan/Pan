...
use pan_codegen_ssa::back::lto::{LtoModuleCodegen, SerializedModule, ThinModule, ThinShared};
use pan_codegen_ssa::back::symbol_export;
...
use pan_codegen_ssa::{looks_like_rust_object_file, ModuleCodegen, ModuleKind};
use pan_data_structures::fx::FxHashMap;
use pan_errors::{FatalError, Handler};
use pan_hir::def_id::LOCAL_CRATE;
use pan_middle::bug;
use pan_middle::dep_graph::WorkProduct;
use pan_middle::middle::exported_symbols::SymbolExportLevel;
use pan_session::cgu_reuse_tracker::CguReuse;
use pan_session::config::{self, CrateType, Lto};
...
pub unsafe fn optimize_thin_module(
    ...
    };
    {
        ...
        // using below. If we find more than one though then pan has changed
