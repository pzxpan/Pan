...
use pan_ast::expand::allocator::ALLOCATOR_METHODS;
...
use pan_middle::ty::{SymbolName, TyCtxt};
use pan_session::config::{CrateType, SanitizerSet};
...
fn exported_symbols_provider_local(
    ...
    if tcx.sess.opts.share_generics() && tcx.local_crate_exports_generics() {
        use pan_middle::mir::mono::{Linkage, MonoItem, Visibility};
        use pan_middle::ty::InstanceDef;
...
pub fn symbol_name_for_instance_in_crate<'tcx>(
    ...
    match symbol {
        ExportedSymbol::NonGeneric(def_id) => {
            pan_symbol_mangling::symbol_name_for_instance_in_crate(
                tcx,
        ...
        ExportedSymbol::DropGlue(ty) => pan_symbol_mangling::symbol_name_for_instance_in_crate(
            tcx,
