use pan_data_structures::fx::FxHashSet;
use pan_data_structures::temp_dir::MaybeTempDir;
use pan_fs_util::fix_windows_verbatim_for_gcc;
use pan_hir::def_id::CrateNum;
use pan_middle::middle::cstore::{EncodedMetadata, LibSource};
use pan_middle::middle::dependency_format::Linkage;
use pan_session::config::{self, CFGuard, CrateType, DebugInfo};
use pan_session::config::{OutputFilenames, OutputType, PrintRequest, SanitizerSet};
use pan_session::output::{check_file_is_writeable, invalid_output_for_target, out_filename};
use pan_session::search_paths::PathKind;
use pan_session::utils::NativeLibKind;
/// For all the linkers we support, and information they might
/// need out of the shared crate context before we get rid of it.
use pan_session::{filesearch, Session};
use pan_span::symbol::Symbol;
use pan_target::spec::crt_objects::{CrtObjects, CrtObjectsFallback};
use pan_target::spec::{LinkOutputKind, LinkerFlavor, LldFlavor};
use pan_target::spec::{PanicStrategy, RelocModel, RelroLevel, Target};
...
fn link_natively<'a, B: ArchiveBuilder<'a>>(
    ...
    println!("fuck  preparing {:?} to {:?}", crate_type, out_filename);
    ...
    // cc -m64 -arch x86_64 -L /Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib" \
    // "test.test.7rcbfp3g-cgu.0.rcgu.o" "test.test.7rcbfp3g-cgu.1.rcgu.o" "test.test.7rcbfp3g-cgu.2.rcgu.o" "test.test.7rcbfp3g-cgu.3.rcgu.o" \
    // "test.test.7rcbfp3g-cgu.4.rcgu.o" "test.test.7rcbfp3g-cgu.5.rcgu.o" "test.test.7rcbfp3g-cgu.6.rcgu.o" "test.test.7rcbfp3g-cgu.7.rcgu.o"\
    //  "-o" "test" "test.5fi6c8ty3hqyycqf.rcgu.o" "-Wl,-dead_strip" "-nodefaultlibs"\
    //   "-L" "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib" \
    //   "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libstd-afca58d35b09ddb8.rlib" \
    //   "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libpanic_unwind-13820c02ef143026.rlib"\
    //    "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libobject-e46a9a14bd3f2eba.rlib" \
    //    "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libaddr2line-29c9087134936453.rlib"\
    //     "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libgimli-68bae7807a363ae5.rlib" \
    //     "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/librustc_demangle-74cd7331f05b8550.rlib" \
    //     "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libhashbrown-1a5605cd0ceaeafc.rlib"\
    //      "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/librustc_std_workspace_alloc-d6c6b1c7cba07f1f.rlib"\
    //       "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libunwind-3e737fde018527dd.rlib"\
    //        "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libcfg_if-9d4175b9af5349c6.rlib"\
    //         "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/liblibc-40ba5e270f4020df.rlib"\
    //          "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/liballoc-7850692ef1f73629.rlib"\
    //           "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/librustc_std_workspace_core-675e5be7577ca9d4.rlib"\
    //            "/Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libcore-f38dfa28d35932f3.rlib
    //     /Users/cuiqingbo/Desktop/Pan/rust/build/x86_64-apple-darwin/stage1/lib/rustlib/x86_64-apple-darwin/lib/libcompiler_builtins-5e1b74b33965fa5d.rlib -lSystem -lresolv -lc "-lm"
    // Invoke the system linker
    println!("fuck here {:?}", &cmd);
...
fn link_sanitizer_runtime(sess: &Session, linker: &mut dyn Linker, name: &str) {
    ...
    match sess.opts.target_triple.triple() {
        "aarch64-apple-darwin" | "x86_64-apple-darwin" => {
            ...
            let libname = format!("pan{}_rt.{}", channel, name);
        ...
        | "x86_64-unknown-linux-gnu" => {
            let filename = format!("libpan{}_rt.{}.a", channel, name);
...
fn add_link_script(cmd: &mut dyn Linker, sess: &Session, tmpdir: &Path, crate_type: CrateType) {
    match (crate_type, &sess.target.link_script) {
        (CrateType::Cdylib | CrateType::Executable, Some(script)) => {
            ...
            let file_name = ["pan", &sess.target.llvm_target, "linkfile.ld"].join("-");
...
fn relevant_lib(sess: &Session, lib: &NativeLib) -> bool {
    match lib.cfg {
        Some(ref cfg) => pan_attr::cfg_matches(cfg, &sess.parse_sess, None),
        None => true,
    }
}
