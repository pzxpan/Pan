...
use pan_data_structures::profiling::TimingGuard;
use pan_data_structures::profiling::VerboseTimingGuard;
use pan_data_structures::sync::Lrc;
use pan_errors::emitter::Emitter;
use pan_errors::{DiagnosticId, FatalError, Handler, Level};
use pan_fs_util::link_or_copy;
...
use pan_middle::middle::exported_symbols::SymbolExportLevel;
use pan_middle::ty::TyCtxt;
use pan_session::cgu_reuse_tracker::CguReuseTracker;
use pan_session::config::{self, CrateType, Lto, OutputFilenames, OutputType};
use pan_session::config::{Passes, SanitizerSet, SwitchWithOptPath};
use pan_session::Session;
use pan_span::source_map::SourceMap;
use pan_span::symbol::{sym, Symbol};
use pan_span::{BytePos, FileName, InnerSpan, Pos, Span};
use pan_target::spec::{MergeFunctions, PanicStrategy};
...
impl Emitter for SharedEmitter {
    fn emit_diagnostic(&mut self, diag: &pan_errors::Diagnostic) {
        ...
        loop {
            ...
            match message {
                Ok(SharedEmitterMessage::Diagnostic(diag)) => {
                    ...
                    let mut d = pan_errors::Diagnostic::new(diag.lvl, &diag.msg);
