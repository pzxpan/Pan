...
use pan_hir::LangItem;
use pan_middle::dep_graph::WorkProduct;
use pan_middle::middle::cstore::{self, CrateSource, LibSource};
use pan_middle::middle::dependency_format::Dependencies;
use pan_middle::ty::query::Providers;
use pan_session::config::{OutputFilenames, OutputType, RUST_CGU_EXT};
...
pub struct CodegenResults {
    ...
    pub metadata: pan_middle::middle::cstore::EncodedMetadata,
