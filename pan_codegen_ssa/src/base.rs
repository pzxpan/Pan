...
use pan_data_structures::sync::{par_iter, Lock, ParallelIterator};
use pan_hir as hir;
use pan_hir::def_id::{LocalDefId, LOCAL_CRATE};
use pan_hir::lang_items::LangItem;
use pan_index::vec::Idx;
use pan_middle::middle::codegen_fn_attrs::CodegenFnAttrs;
use pan_middle::middle::cstore::EncodedMetadata;
use pan_middle::middle::cstore::{self, LinkagePreference};
use pan_middle::middle::lang_items;
use pan_middle::mir::mono::{CodegenUnit, CodegenUnitNameBuilder, MonoItem};
use pan_middle::ty::layout::{HasTyCtxt, TyAndLayout};
use pan_middle::ty::layout::{FAT_PTR_ADDR, FAT_PTR_EXTRA};
use pan_middle::ty::query::Providers;
use pan_middle::ty::{self, Instance, Ty, TyCtxt};
use pan_session::cgu_reuse_tracker::CguReuse;
use pan_session::config::{self, EntryFnType};
use pan_session::utils::NativeLibKind;
use pan_session::Session;
use pan_target::abi::{Align, LayoutOf, VariantIdx};
