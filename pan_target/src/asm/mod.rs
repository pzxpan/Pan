...
macro_rules! def_reg_class {
    ($arch:ident $arch_regclass:ident {
        ...
        impl $arch_regclass {
            pub fn name(self) -> pan_span::Symbol {
                match self {
                    $(Self::$class => pan_span::symbol::sym::$class,)*
                }
            }

            pub fn parse(_arch: super::InlineAsmArch, name: pan_span::Symbol) -> Result<Self, &'static str> {
                match name {
                    $(
                        pan_span::sym::$class => Ok(Self::$class),
                    )*
        ...
        pub(super) fn regclass_map() -> pan_data_structures::fx::FxHashMap<
            super::InlineAsmRegClass,
            pan_data_structures::fx::FxHashSet<super::InlineAsmReg>,
        > {
            use pan_data_structures::fx::{FxHashMap, FxHashSet};
...
macro_rules! def_regs {
    ($arch:ident $arch_reg:ident $arch_regclass:ident {
        ...
        pub(super) fn fill_reg_map(
            ...
            mut _has_feature: impl FnMut(&str) -> bool,
            _target: &crate::spec::Target,
            _map: &mut pan_data_structures::fx::FxHashMap<
                super::InlineAsmRegClass,
                pan_data_structures::fx::FxHashSet<super::InlineAsmReg>,
            >,
        ) {
