...
use pan_middle::ty::subst::{GenericArg, InternalSubsts, Subst};
use pan_middle::ty::{self, Ty, TyCtxt, TypeFoldable, TypeVisitor, WithConstness};
use pan_middle::ty::{Predicate, ToPredicate};
use pan_session::lint::builtin::WHERE_CLAUSES_OBJECT_SAFETY;
...
fn contains_illegal_self_type_reference<'tcx, T: TypeFoldable<'tcx>>(
    ...
    impl<'tcx> TypeVisitor<'tcx> for IllegalSelfTypeVisitor<'tcx> {
        ...
        fn visit_const(&mut self, ct: &ty::Const<'tcx>) -> ControlFlow<Self::BreakTy> {
            ...
            use pan_middle::mir::abstract_const::Node;
