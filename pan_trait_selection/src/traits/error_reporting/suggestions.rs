...
use pan_errors::{error_code, struct_span_err, Applicability, DiagnosticBuilder, Style};
use pan_hir as hir;
use pan_hir::def::DefKind;
use pan_hir::def_id::DefId;
use pan_hir::intravisit::Visitor;
use pan_hir::lang_items::LangItem;
use pan_hir::{AsyncGeneratorKind, GeneratorKind, Node};
use pan_middle::ty::{
    self, suggest_constraining_type_param, AdtKind, DefIdTree, Infer, InferTy, ToPredicate, Ty,
    TyCtxt, TypeFoldable, WithConstness,
};
use pan_middle::ty::{TypeAndMut, TypeckResults};
