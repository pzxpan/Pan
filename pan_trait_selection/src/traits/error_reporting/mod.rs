...
use pan_errors::{pluralize, struct_span_err, Applicability, DiagnosticBuilder, ErrorReported};
use pan_hir as hir;
use pan_hir::def_id::{DefId, LOCAL_CRATE};
use pan_hir::intravisit::Visitor;
use pan_hir::Node;
use pan_middle::mir::interpret::ErrorHandled;
use pan_middle::ty::error::ExpectedFound;
...
use pan_span::{ExpnKind, MultiSpan, Span, DUMMY_SP};
use std::fmt;
...
pub use pan_infer::traits::error_reporting::*;
...
struct FindTypeParam {
    param: pan_span::Symbol,
    invalid_spans: Vec<Span>,
    nested: bool,
}

impl<'v> Visitor<'v> for FindTypeParam {
    type Map = pan_hir::intravisit::ErasedMap<'v>;
