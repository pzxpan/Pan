...
use pan_hir::Constness;
use pan_middle::dep_graph::{DepKind, DepNodeIndex};
use pan_middle::mir::interpret::ErrorHandled;
use pan_middle::ty::fast_reject;
use pan_middle::ty::print::with_no_trimmed_paths;
use pan_middle::ty::relate::TypeRelation;
use pan_middle::ty::subst::{GenericArgKind, Subst, SubstsRef};
use pan_middle::ty::{self, PolyProjectionPredicate, ToPolyTraitRef, ToPredicate};
use pan_middle::ty::{Ty, TyCtxt, TypeFoldable, WithConstness};
...
pub use pan_middle::traits::select::*;
...
impl IntercrateAmbiguityCause {
    ...
    pub fn add_intercrate_ambiguity_hint(&self, err: &mut pan_errors::DiagnosticBuilder<'_>) {
