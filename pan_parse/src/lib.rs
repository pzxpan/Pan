...
use pan_ast::tokenstream::{self, CanSynthesizeMissingTokens, LazyTokenStream, TokenStream};
use pan_ast_pretty::pprust;
use pan_data_structures::sync::Lrc;
use pan_errors::{Diagnostic, FatalError, Level, PResult};
use pan_session::parse::ParseSess;
use pan_span::{FileName, SourceFile, Span};
...
pub fn nt_to_tokenstream(
    ...
    if let Some(tokens) = tokens {
        ...
        let pretty = pan_ast_pretty::pprust::nonterminal_to_string_no_extra_parens(&nt);
