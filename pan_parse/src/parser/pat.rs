...
use pan_ast::mut_visit::{noop_visit_pat, MutVisitor};
use pan_ast::ptr::P;
use pan_ast::token;
use pan_ast::{self as ast, AttrVec, Attribute, FieldPat, MacCall, Pat, PatKind, RangeEnd};
use pan_ast::{BindingMode, Expr, ExprKind, Mutability, Path, QSelf, RangeSyntax};
use pan_ast_pretty::pprust;
use pan_errors::{struct_span_err, Applicability, DiagnosticBuilder, PResult};
use pan_span::source_map::{respan, Span, Spanned};
