...
use pan_ast::{EnumDef, Generics, StructField, TraitRef, Ty, TyKind, Variant, VariantData};
use pan_ast::{FnHeader, ForeignItem, Path, PathSegment, Visibility, VisibilityKind};
use pan_ast::{MacArgs, MacCall, MacDelimiter};
use pan_ast_pretty::pprust;
use pan_errors::{struct_span_err, Applicability, PResult, StashKey};
use pan_span::edition::{Edition, LATEST_STABLE_EDITION};
use pan_span::source_map::{self, Span};
