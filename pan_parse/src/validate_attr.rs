...
use pan_ast::tokenstream::DelimSpan;
use pan_ast::{self as ast, Attribute, MacArgs, MacDelimiter, MetaItem, MetaItemKind};
use pan_errors::{Applicability, PResult};
use pan_feature::{AttributeTemplate, BUILTIN_ATTRIBUTE_MAP};
use pan_session::lint::builtin::ILL_FORMED_ATTRIBUTE_INPUT;
