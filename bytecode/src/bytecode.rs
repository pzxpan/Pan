...
pub enum Instruction {
    ...
    LoadFunctionCallFrameReference(usize, usize, NameScope),
    StoreFunctionCallFrameReference(usize, usize, NameScope),
...
impl Instruction {
    fn fmt_dis(
        ...
        match self {
            ...
            LoadMutex(name) => w!(LoadMutex,name),
            StoreMutex(name) => w!(StoreMutex,name),
            ...
            LoadFunctionCallFrameReference(scope_idx, variable_idx, n) => w!(LoadFrameReference, scope_idx, variable_idx,format!("{:?}", n)),
            StoreFunctionCallFrameReference(scope_idx, variable_idx, n) => w!(StoreFrameReference,scope_idx,variable_idx,format!("{:?}", n)),
