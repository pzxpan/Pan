...
use pan_hir::def_id::{CrateNum, DefId, DefIdMap, LOCAL_CRATE};
use pan_hir::intravisit::{self, NestedVisitorMap, Visitor};
use pan_hir::{GenericArg, GenericParam, LifetimeName, Node, ParamName, QPath};
use pan_hir::{GenericParamKind, HirIdMap, HirIdSet, LifetimeParamKind};
use pan_middle::hir::map::Map;
use pan_middle::middle::resolve_lifetime::*;
use pan_middle::ty::{self, DefIdTree, GenericParamDefKind, TyCtxt};
