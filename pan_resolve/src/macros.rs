...
use pan_expand::base::{Indeterminate, InvocationRes, ResolverExpand, SyntaxExtension};
use pan_expand::compile_declarative_macro;
use pan_expand::expand::{AstFragment, Invocation, InvocationKind};
use pan_feature::is_builtin_attr_name;
use pan_hir::def::{self, DefKind, NonMacroAttrKind};
use pan_hir::def_id;
use pan_middle::middle::stability;
use pan_middle::ty;
use pan_session::lint::builtin::{SOFT_UNSTABLE, UNUSED_MACROS};
use pan_session::parse::feature_err;
use pan_session::Session;
use pan_span::edition::Edition;
use pan_span::hygiene::{self, ExpnData, ExpnId, ExpnKind};
use pan_span::hygiene::{AstPass, MacroKind};
