...
// candidates here, and do the actual check in libpan_typeck/check_unused.rs.
//
...
use pan_errors::pluralize;
use pan_middle::ty;
use pan_session::lint::builtin::{MACRO_USE_EXTERN_CRATE, UNUSED_IMPORTS};
