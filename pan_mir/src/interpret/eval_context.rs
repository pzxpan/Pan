...
use pan_hir::{self as hir, def_id::DefId, definitions::DefPathData};
use pan_index::vec::IndexVec;
use pan_macros::HashStable;
use pan_middle::ich::StableHashingContext;
use pan_middle::mir;
use pan_middle::mir::interpret::{GlobalId, InterpResult, Pointer, Scalar};
use pan_middle::ty::layout::{self, TyAndLayout};
use pan_middle::ty::{
    self, query::TyCtxtAt, subst::SubstsRef, ParamEnv, Ty, TyCtxt, TypeFoldable,
};
use pan_span::{Pos, Span};
use pan_target::abi::{Align, HasDataLayout, LayoutOf, Size, TargetDataLayout};
