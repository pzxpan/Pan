...
use pan_index::bit_set::{BitMatrix, BitSet};
use pan_index::vec::{Idx, IndexVec};
use pan_middle::mir::visit::{MutVisitor, PlaceContext, Visitor};
use pan_middle::mir::*;
use pan_middle::ty::subst::{Subst, SubstsRef};
use pan_middle::ty::GeneratorSubsts;
use pan_middle::ty::{self, AdtDef, Ty, TyCtxt};
...
fn create_generator_resume_function<'tcx>(
    ...
    use pan_middle::mir::AssertKind::{ResumedAfterPanic, ResumedAfterReturn};
