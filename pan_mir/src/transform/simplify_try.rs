...
use pan_index::{bit_set::BitSet, vec::IndexVec};
use pan_middle::mir::visit::{NonUseContext, PlaceContext, Visitor};
use pan_middle::mir::*;
use pan_middle::ty::{self, List, Ty, TyCtxt};
...
fn get_arm_identity_info<'a, 'tcx>(
    ...
    fn is_tmp_storage_stmt<'tcx>(stmt: &Statement<'tcx>) -> bool {
        use pan_middle::mir::StatementKind::Assign;
