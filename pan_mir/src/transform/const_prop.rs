...
use pan_middle::ty::layout::{HasTyCtxt, LayoutError, TyAndLayout};
use pan_middle::ty::subst::{InternalSubsts, Subst};
use pan_middle::ty::{
    self, ConstInt, ConstKind, Instance, ParamEnv, ScalarInt, Ty, TyCtxt, TypeFoldable,
};
use pan_session::lint;
use pan_span::{def_id::DefId, Span};
use pan_target::abi::{HasDataLayout, LayoutOf, Size, TargetDataLayout};
...
macro_rules! throw_machine_stop_str {
    ($($tt:tt)*) => {{
        ...
        impl pan_middle::mir::interpret::MachineStopType for Zst {}
...
impl<'mir, 'tcx> interpret::Machine<'mir, 'tcx> for ConstPropMachine<'mir, 'tcx> {
    ...
    fn assert_panic(
        _ecx: &mut InterpCx<'mir, 'tcx, Self>,
        _msg: &pan_middle::mir::AssertMessage<'tcx>,
        _unwind: Option<pan_middle::mir::BasicBlock>,
    ) -> InterpResult<'tcx> {
...
impl<'tcx> Visitor<'tcx> for CanConstProp {
    fn visit_local(&mut self, &local: &Local, context: PlaceContext, _: Location) {
        use pan_middle::mir::visit::PlaceContext::*;
        match context {
