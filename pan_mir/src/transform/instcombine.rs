        ...
        if let Rvalue::Use(op) = rvalue {
            ...
            for stmt in statements_to_look_in {
                match &stmt.kind {
                    ...
                    pan_middle::mir::StatementKind::Assign(box (l, r))
                    ...
                    pan_middle::mir::StatementKind::LlvmInlineAsm(_) => return None,
                    ...
                    pan_middle::mir::StatementKind::StorageDead(dead) => {
                    ...
                    pan_middle::mir::StatementKind::Assign(box (_, _))
                    | pan_middle::mir::StatementKind::Coverage(_)
                    | pan_middle::mir::StatementKind::Nop
                    | pan_middle::mir::StatementKind::FakeRead(_, _)
                    | pan_middle::mir::StatementKind::StorageLive(_)
                    | pan_middle::mir::StatementKind::Retag(_, _)
                    | pan_middle::mir::StatementKind::AscribeUserType(_, _)
                    | pan_middle::mir::StatementKind::SetDiscriminant { .. } => {
