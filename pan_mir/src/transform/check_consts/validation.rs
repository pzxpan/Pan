...
use pan_errors::{struct_span_err, Applicability, Diagnostic, ErrorReported};
use pan_hir::def_id::DefId;
use pan_hir::{self as hir, HirId, LangItem};
use pan_infer::infer::TyCtxtInferExt;
use pan_infer::traits::{ImplSource, Obligation, ObligationCause};
use pan_middle::mir::visit::{MutatingUseContext, NonMutatingUseContext, PlaceContext, Visitor};
use pan_middle::mir::*;
...
use pan_middle::ty::{Binder, TraitPredicate, TraitRef};
use pan_span::{sym, Span, Symbol};
use pan_trait_selection::traits::error_reporting::InferCtxtExt;
use pan_trait_selection::traits::{self, SelectionContext, TraitEngine};
