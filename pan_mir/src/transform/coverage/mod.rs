...
use pan_data_structures::graph::WithNumNodes;
...
use pan_middle::ich::StableHashingContext;
use pan_middle::mir::coverage::*;
use pan_middle::mir::{
...
use pan_span::{CharPos, Pos, SourceFile, Span, Symbol};
...
fn fn_sig_and_body<'tcx>(
    tcx: TyCtxt<'tcx>,
    def_id: DefId,
) -> (Option<&'tcx pan_hir::FnSig<'tcx>>, &'tcx pan_hir::Body<'tcx>) {
...
fn hash_mir_source<'tcx>(tcx: TyCtxt<'tcx>, hir_body: &'tcx pan_hir::Body<'tcx>) -> u64 {
