...
use pan_data_structures::sync::{par_iter, MTLock, MTRef, ParallelIterator};
use pan_errors::{ErrorReported, FatalError};
use pan_hir as hir;
use pan_hir::def_id::{DefId, DefIdMap, LocalDefId, LOCAL_CRATE};
use pan_hir::itemlikevisit::ItemLikeVisitor;
use pan_hir::lang_items::LangItem;
use pan_index::bit_set::GrowableBitSet;
use pan_middle::middle::codegen_fn_attrs::CodegenFnAttrFlags;
use pan_middle::mir::interpret::{AllocId, ConstValue};
use pan_middle::mir::interpret::{ErrorHandled, GlobalAlloc, Scalar};
use pan_middle::mir::mono::{InstantiationMode, MonoItem};
use pan_middle::mir::visit::Visitor as MirVisitor;
use pan_middle::mir::{self, Local, Location};
use pan_middle::ty::adjustment::{CustomCoerceUnsized, PointerCast};
use pan_middle::ty::subst::{GenericArgKind, InternalSubsts};
use pan_middle::ty::{self, GenericParamDefKind, Instance, Ty, TyCtxt, TypeFoldable};
use pan_session::config::EntryFnType;
use pan_span::source_map::{dummy_spanned, respan, Span, Spanned, DUMMY_SP};
...
fn collect_items_rec<'tcx>(
    ...
    match starting_point.node {
        ...
        MonoItem::Fn(instance) => {
            ...
            pan_data_structures::stack::ensure_sufficient_stack(|| {
