use pan_data_structures::graph::{self, iterate};
...
pub struct GraphvizWriter<
    ...
    NodeContentFn: Fn(<G as pan_data_structures::graph::DirectedGraph>::Node) -> Vec<String>,
    EdgeLabelsFn: Fn(<G as pan_data_structures::graph::DirectedGraph>::Node) -> Vec<String>,
> {
    graph: &'a G,
    is_subgraph: bool,
