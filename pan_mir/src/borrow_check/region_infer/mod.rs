...
use pan_data_structures::binary_search_util;
use pan_data_structures::frozen::Frozen;
use pan_data_structures::fx::{FxHashMap, FxHashSet};
use pan_data_structures::graph::scc::Sccs;
use pan_hir::def_id::DefId;
use pan_index::vec::IndexVec;
use pan_infer::infer::canonical::QueryOutlivesConstraint;
use pan_infer::infer::region_constraints::{GenericKind, VarInfos, VerifyBound};
use pan_infer::infer::{InferCtxt, NLLRegionVariableOrigin, RegionVariableOrigin};
use pan_middle::mir::{
    Body, ClosureOutlivesRequirement, ClosureOutlivesSubject, ClosureRegionRequirements,
    ConstraintCategory, Local, Location, ReturnConstraint,
};
use pan_middle::ty::{self, subst::SubstsRef, RegionVid, Ty, TyCtxt, TypeFoldable};
use pan_span::Span;
...
impl<'tcx> RegionInferenceContext<'tcx> {
    ...
    crate fn annotate(&self, tcx: TyCtxt<'tcx>, err: &mut pan_errors::DiagnosticBuilder<'_>) {
