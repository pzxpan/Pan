...
use pan_data_structures::graph::dominators::Dominators;
use pan_errors::{Applicability, Diagnostic, DiagnosticBuilder, ErrorReported};
use pan_hir as hir;
use pan_hir::def_id::LocalDefId;
use pan_hir::{HirId, Node};
use pan_index::bit_set::BitSet;
use pan_index::vec::IndexVec;
use pan_infer::infer::{InferCtxt, TyCtxtInferExt};
use pan_middle::hir::place::PlaceBase as HirPlaceBase;
use pan_middle::mir::{
    traversal, Body, ClearCrossCrate, Local, Location, Mutability, Operand, Place, PlaceElem,
    PlaceRef, VarDebugInfoContents,
};
use pan_middle::mir::{AggregateKind, BasicBlock, BorrowCheckResult, BorrowKind};
use pan_middle::mir::{Field, ProjectionElem, Promoted, Rvalue, Statement, StatementKind};
use pan_middle::mir::{InlineAsmOperand, Terminator, TerminatorKind};
use pan_middle::ty::query::Providers;
use pan_middle::ty::{self, ParamEnv, RegionVid, TyCtxt};
use pan_session::lint::builtin::{MUTABLE_BORROW_RESERVATION_CONFLICT, UNUSED_MUT};
