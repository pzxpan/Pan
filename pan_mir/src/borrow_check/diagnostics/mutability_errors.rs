...
use pan_middle::mir::{self, ClearCrossCrate, Local, LocalDecl, LocalInfo, Location};
use pan_middle::mir::{Mutability, Place, PlaceRef, ProjectionElem};
use pan_middle::ty::{self, Ty, TyCtxt};
use pan_span::source_map::DesugaringKind;
use pan_span::symbol::{kw, Symbol};
use pan_span::Span;
...
fn suggest_ref_mut(tcx: TyCtxt<'_>, binding_span: Span) -> Option<String> {
    ...
    if hi_src.starts_with("ref") && hi_src["ref".len()..].starts_with(pan_lexer::is_whitespace) {
