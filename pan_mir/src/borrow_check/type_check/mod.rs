...
use pan_data_structures::frozen::Frozen;
use pan_data_structures::fx::{FxHashMap, FxHashSet};
use pan_errors::struct_span_err;
use pan_hir as hir;
use pan_hir::def_id::{DefId, LocalDefId};
use pan_hir::lang_items::LangItem;
use pan_index::vec::{Idx, IndexVec};
use pan_infer::infer::canonical::QueryRegionConstraints;
use pan_infer::infer::outlives::env::RegionBoundPairs;
use pan_infer::infer::type_variable::{TypeVariableOrigin, TypeVariableOriginKind};
use pan_infer::infer::{
    InferCtxt, InferOk, LateBoundRegionConversionTime, NLLRegionVariableOrigin,
};
use pan_middle::mir::tcx::PlaceTy;
use pan_middle::mir::visit::{NonMutatingUseContext, PlaceContext, Visitor};
use pan_middle::mir::AssertKind;
use pan_middle::mir::*;
use pan_middle::ty::adjustment::PointerCast;
use pan_middle::ty::cast::CastTy;
use pan_middle::ty::fold::TypeFoldable;
use pan_middle::ty::subst::{GenericArgKind, Subst, SubstsRef, UserSubsts};
use pan_middle::ty::{
...
use pan_trait_selection::opaque_types::{GenerateMemberConstraints, InferCtxtExt};
use pan_trait_selection::traits::error_reporting::InferCtxtExt as _;
use pan_trait_selection::traits::query::type_op;
use pan_trait_selection::traits::query::type_op::custom::CustomTypeOp;
use pan_trait_selection::traits::query::{Fallible, NoSolution};
use pan_trait_selection::traits::{self, ObligationCause, PredicateObligations};
