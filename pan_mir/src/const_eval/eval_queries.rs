...
use pan_middle::traits::Reveal;
use pan_middle::ty::print::with_no_trimmed_paths;
use pan_middle::ty::{self, subst::Subst, TyCtxt};
use pan_span::source_map::Span;
use pan_target::abi::{Abi, LayoutOf};
...
pub fn eval_to_const_value_raw_provider<'tcx>(
    tcx: TyCtxt<'tcx>,
    key: ty::ParamEnvAnd<'tcx, GlobalId<'tcx>>,
) -> ::pan_middle::mir::interpret::EvalToConstValueResult<'tcx> {
...
pub fn eval_to_allocation_raw_provider<'tcx>(
    tcx: TyCtxt<'tcx>,
    key: ty::ParamEnvAnd<'tcx, GlobalId<'tcx>>,
) -> ::pan_middle::mir::interpret::EvalToAllocationRawResult<'tcx> {
