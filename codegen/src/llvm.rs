// //! The LLVM module handles converting Pan IR to LLVM IR.
//
...
//
// use pan_bytecode::bytecode::{Instruction, CodeObject};
...
//     );
//
//     let increment_amount = int8(amount.int_value() as c_ulonglong);
...
//     LLVMBuildStore(
//         builder.builder,
//         int8(amount.int_value() as c_ulonglong),
//         current_cell_ptr,
//     );
//     bb
// }
...
//         let factor = changes.get(target).unwrap().clone();
//         let additional_val = LLVMBuildMul(
//             builder.builder,
//             cell_val,
//             int8(factor.int_value() as c_ulonglong),
