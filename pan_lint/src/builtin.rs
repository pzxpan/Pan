...
use pan_ast::attr::{self, HasAttrs};
use pan_ast::tokenstream::{TokenStream, TokenTree};
use pan_ast::visit::{FnCtxt, FnKind};
use pan_ast::{self as ast, *};
use pan_ast_pretty::pprust::{self, expr_to_string};
use pan_data_structures::fx::{FxHashMap, FxHashSet};
use pan_data_structures::stack::ensure_sufficient_stack;
use pan_errors::{Applicability, DiagnosticBuilder, DiagnosticStyledString};
use pan_feature::{deprecated_attributes, AttributeGate, AttributeTemplate, AttributeType};
use pan_feature::{GateIssue, Stability};
use pan_hir as hir;
use pan_hir::def::{DefKind, Res};
use pan_hir::def_id::DefId;
use pan_hir::{ForeignItemKind, GenericParamKind, PatKind};
use pan_hir::{HirId, HirIdSet, Node};
use pan_index::vec::Idx;
use pan_middle::lint::LintDiagnosticBuilder;
use pan_middle::ty::print::with_no_trimmed_paths;
use pan_middle::ty::subst::{GenericArgKind, Subst};
use pan_middle::ty::{self, layout::LayoutError, Ty, TyCtxt};
use pan_session::Session;
use pan_span::edition::Edition;
use pan_span::source_map::Spanned;
use pan_span::symbol::{kw, sym, Ident, Symbol};
use pan_span::{BytePos, Span};
use pan_target::abi::{LayoutOf, VariantIdx};
use pan_trait_selection::traits::misc::can_type_implement_copy;
...
pub use pan_session::lint::builtin::*;
...
impl<'tcx> LateLintPass<'tcx> for MutableTransmutes {
    fn check_expr(&mut self, cx: &LateContext<'_>, expr: &hir::Expr<'_>) {
        use pan_target::spec::abi::Abi::RustIntrinsic;
...
impl TypeAliasBounds {
    ...
    fn suggest_changing_assoc_types(ty: &hir::Ty<'_>, err: &mut DiagnosticBuilder<'_>) {
        ...
        use pan_hir::intravisit::{self, Visitor};
...
impl<'tcx> LateLintPass<'tcx> for TrivialConstraints {
    fn check_item(&mut self, cx: &LateContext<'tcx>, item: &'tcx hir::Item<'tcx>) {
        use pan_middle::ty::fold::TypeFoldable;
        use pan_middle::ty::PredicateAtom::*;
...
impl ExplicitOutlivesRequirements {
    ...
    fn collect_outlives_bound_spans<'tcx>(
        ...
        use pan_middle::middle::resolve_lifetime::Region;
...
impl EarlyLintPass for IncompleteFeatures {
    fn check_crate(&mut self, cx: &EarlyContext<'_>, _: &ast::Crate) {
        ...
        features
            ...
            .filter(|(name, _)| pan_feature::INCOMPLETE_FEATURES.iter().any(|f| name == &f))
            .for_each(|(&name, &span)| {
                cx.struct_span_lint(INCOMPLETE_FEATURES, span, |lint| {
                    ...
                    if let Some(n) = pan_feature::find_feature_issue(name, GateIssue::Language) {
                        builder.note(&format!(
...
impl ClashingExternDeclarations {
    ...
    fn structurally_same_type<'tcx>(
        ...
        fn structurally_same_type_impl<'tcx>(
            ...
            let tcx = cx.tcx;
            if a == b || pan_middle::ty::TyS::same_type(a, b) {
