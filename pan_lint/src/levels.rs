...
use pan_hir::{intravisit, HirId};
use pan_middle::hir::map::Map;
use pan_middle::lint::LevelSource;
...
use pan_session::lint::{builtin, Level, Lint, LintId};
use pan_session::parse::feature_err;
use pan_session::Session;
use pan_span::symbol::{sym, Symbol};
use pan_span::{source_map::MultiSpan, Span, DUMMY_SP};
