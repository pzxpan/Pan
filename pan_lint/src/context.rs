...
use pan_errors::{add_elided_lifetime_in_path_suggestion, struct_span_err, Applicability};
use pan_hir as hir;
use pan_hir::def::Res;
use pan_hir::def_id::{CrateNum, DefId};
use pan_hir::definitions::{DefPathData, DisambiguatedDefPathData};
use pan_middle::lint::LintDiagnosticBuilder;
use pan_middle::middle::privacy::AccessLevels;
use pan_middle::middle::stability;
use pan_middle::ty::layout::{LayoutError, TyAndLayout};
use pan_middle::ty::print::with_no_trimmed_paths;
use pan_middle::ty::{self, print::Printer, subst::GenericArg, Ty, TyCtxt};
use pan_session::lint::BuiltinLintDiagnostics;
use pan_session::lint::{FutureIncompatibleInfo, Level, Lint, LintBuffer, LintId};
use pan_session::Session;
use pan_session::SessionLintStore;
use pan_span::lev_distance::find_best_match_for_name;
use pan_span::{symbol::Symbol, MultiSpan, Span, DUMMY_SP};
use pan_target::abi::LayoutOf;
