...
use pan_hir as hir;
use pan_session::lint::builtin::HardwiredLints;
...
macro_rules! late_lint_methods {
    ($macro:path, $args:tt, [$hir:tt]) => (
        $macro!($args, [$hir], [
            ...
            fn check_fn(
                a: pan_hir::intravisit::FnKind<$hir>,
...
macro_rules! early_lint_methods {
    ($macro:path, $args:tt) => (
        $macro!($args, [
            ...
            fn check_fn(a: pan_ast::visit::FnKind<'_>, c: Span, d_: ast::NodeId);
            fn check_fn_post(
                a: pan_ast::visit::FnKind<'_>,
                c: Span,
                d: ast::NodeId
            );
