...
use pan_hir as hir;
use pan_hir::{is_range_literal, ExprKind, Node};
use pan_index::vec::Idx;
use pan_middle::ty::layout::{IntegerExt, SizeSkeleton};
use pan_middle::ty::subst::SubstsRef;
use pan_middle::ty::{self, AdtKind, Ty, TyCtxt, TypeFoldable};
use pan_span::source_map;
use pan_span::symbol::sym;
use pan_span::{Span, DUMMY_SP};
use pan_target::abi::Abi;
use pan_target::abi::{Integer, LayoutOf, TagEncoding, VariantIdx, Variants};
use pan_target::spec::abi::Abi as SpecAbi;
