...
use pan_arena::TypedArena;
use pan_ast::Mutability;
use pan_errors::{error_code, struct_span_err, Applicability, DiagnosticBuilder};
use pan_hir as hir;
use pan_hir::def::*;
use pan_hir::def_id::DefId;
use pan_hir::intravisit::{self, NestedVisitorMap, Visitor};
use pan_hir::{HirId, Pat};
use pan_middle::ty::{self, Ty, TyCtxt};
use pan_session::lint::builtin::BINDINGS_WITH_VARIANT_NAME;
use pan_session::lint::builtin::{IRREFUTABLE_LET_PATTERNS, UNREACHABLE_PATTERNS};
        ...
        for error in &self.errors {
            match *error {
                ...
                PatternError::FloatBug => {
                    ...
                    pan_middle::mir::interpret::struct_error(
...
fn pattern_not_covered_label(witnesses: &[super::Pat<'_>], joined_patterns: &str) -> String {
    format!("pattern{} {} not covered", pan_errors::pluralize!(witnesses.len()), joined_patterns)
}
