...
use pan_middle::hir::place::ProjectionKind as HirProjectionKind;
use pan_middle::mir::interpret::Scalar;
use pan_middle::mir::BorrowKind;
use pan_middle::ty::adjustment::{
    Adjust, Adjustment, AutoBorrow, AutoBorrowMutability, PointerCast,
};
use pan_middle::ty::subst::{InternalSubsts, SubstsRef};
use pan_middle::ty::{self, AdtKind, Ty};
use pan_span::Span;
...
impl ToBorrowKind for AutoBorrowMutability {
    fn to_borrow_kind(&self) -> BorrowKind {
        use pan_middle::ty::adjustment::AllowTwoPhase;
        match *self {
