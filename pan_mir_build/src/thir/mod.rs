...
use pan_middle::infer::canonical::Canonical;
use pan_middle::middle::region;
use pan_middle::mir::{BinOp, BorrowKind, Field, UnOp};
use pan_middle::ty::adjustment::PointerCast;
use pan_middle::ty::subst::SubstsRef;
use pan_middle::ty::{AdtDef, Const, Ty, UpvarSubsts, UserType};
use pan_span::Span;
...
pan_data_structures::static_assert_size!(Expr<'_>, 168);
