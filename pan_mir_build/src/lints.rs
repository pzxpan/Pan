use pan_data_structures::graph::iterate::{
    NodeStatus, TriColorDepthFirstSearch, TriColorVisitor,
};
use pan_hir::intravisit::FnKind;
use pan_middle::hir::map::blocks::FnLikeNode;
use pan_middle::mir::{BasicBlock, Body, Operand, TerminatorKind};
use pan_middle::ty::subst::{GenericArg, InternalSubsts};
use pan_middle::ty::{self, AssocItem, AssocItemContainer, Instance, TyCtxt};
use pan_session::lint::builtin::UNCONDITIONAL_RECURSION;
use pan_span::Span;
