...
impl IntPredicate {
    // pub fn from_generic(intpre: pan_codegen_ssa::common::IntPredicate) -> Self {
    //     match intpre {
    //         pan_codegen_ssa::common::IntPredicate::IntEQ => IntPredicate::IntEQ,
    //         pan_codegen_ssa::common::IntPredicate::IntNE => IntPredicate::IntNE,
    //         pan_codegen_ssa::common::IntPredicate::IntUGT => IntPredicate::IntUGT,
    //         pan_codegen_ssa::common::IntPredicate::IntUGE => IntPredicate::IntUGE,
    //         pan_codegen_ssa::common::IntPredicate::IntULT => IntPredicate::IntULT,
    //         pan_codegen_ssa::common::IntPredicate::IntULE => IntPredicate::IntULE,
    //         pan_codegen_ssa::common::IntPredicate::IntSGT => IntPredicate::IntSGT,
    //         pan_codegen_ssa::common::IntPredicate::IntSGE => IntPredicate::IntSGE,
    //         pan_codegen_ssa::common::IntPredicate::IntSLT => IntPredicate::IntSLT,
    //         pan_codegen_ssa::common::IntPredicate::IntSLE => IntPredicate::IntSLE,
    //     }
    // }
}
...
impl RealPredicate {
    // pub fn from_generic(realpred: pan_codegen_ssa::common::RealPredicate) -> Self {
    //     match realpred {
    //         pan_codegen_ssa::common::RealPredicate::RealPredicateFalse => {
    //             RealPredicate::RealPredicateFalse
    //         }
    //         pan_codegen_ssa::common::RealPredicate::RealOEQ => RealPredicate::RealOEQ,
    //         pan_codegen_ssa::common::RealPredicate::RealOGT => RealPredicate::RealOGT,
    //         pan_codegen_ssa::common::RealPredicate::RealOGE => RealPredicate::RealOGE,
    //         pan_codegen_ssa::common::RealPredicate::RealOLT => RealPredicate::RealOLT,
    //         pan_codegen_ssa::common::RealPredicate::RealOLE => RealPredicate::RealOLE,
    //         pan_codegen_ssa::common::RealPredicate::RealONE => RealPredicate::RealONE,
    //         pan_codegen_ssa::common::RealPredicate::RealORD => RealPredicate::RealORD,
    //         pan_codegen_ssa::common::RealPredicate::RealUNO => RealPredicate::RealUNO,
    //         pan_codegen_ssa::common::RealPredicate::RealUEQ => RealPredicate::RealUEQ,
    //         pan_codegen_ssa::common::RealPredicate::RealUGT => RealPredicate::RealUGT,
    //         pan_codegen_ssa::common::RealPredicate::RealUGE => RealPredicate::RealUGE,
    //         pan_codegen_ssa::common::RealPredicate::RealULT => RealPredicate::RealULT,
    //         pan_codegen_ssa::common::RealPredicate::RealULE => RealPredicate::RealULE,
    //         pan_codegen_ssa::common::RealPredicate::RealUNE => RealPredicate::RealUNE,
    //         pan_codegen_ssa::common::RealPredicate::RealPredicateTrue => {
...
impl TypeKind {
    // pub fn to_generic(self) -> pan_codegen_ssa::common::TypeKind {
    //     match self {
    //         TypeKind::Void => pan_codegen_ssa::common::TypeKind::Void,
    //         TypeKind::Half => pan_codegen_ssa::common::TypeKind::Half,
    //         TypeKind::Float => pan_codegen_ssa::common::TypeKind::Float,
    //         TypeKind::Double => pan_codegen_ssa::common::TypeKind::Double,
    //         TypeKind::X86_FP80 => pan_codegen_ssa::common::TypeKind::X86_FP80,
    //         TypeKind::FP128 => pan_codegen_ssa::common::TypeKind::FP128,
    //         TypeKind::PPC_FP128 => pan_codegen_ssa::common::TypeKind::PPC_FP128,
    //         TypeKind::Label => pan_codegen_ssa::common::TypeKind::Label,
    //         TypeKind::Integer => pan_codegen_ssa::common::TypeKind::Integer,
    //         TypeKind::Function => pan_codegen_ssa::common::TypeKind::Function,
    //         TypeKind::Struct => pan_codegen_ssa::common::TypeKind::Struct,
    //         TypeKind::Array => pan_codegen_ssa::common::TypeKind::Array,
    //         TypeKind::Pointer => pan_codegen_ssa::common::TypeKind::Pointer,
    //         TypeKind::Vector => pan_codegen_ssa::common::TypeKind::Vector,
    //         TypeKind::Metadata => pan_codegen_ssa::common::TypeKind::Metadata,
    //         TypeKind::X86_MMX => pan_codegen_ssa::common::TypeKind::X86_MMX,
    //         TypeKind::Token => pan_codegen_ssa::common::TypeKind::Token,
    //         TypeKind::ScalableVector => pan_codegen_ssa::common::TypeKind::ScalableVector,
    //         TypeKind::BFloat => pan_codegen_ssa::common::TypeKind::BFloat,
    //     }
    // }
}
...
impl AtomicRmwBinOp {
    // pub fn from_generic(op: pan_codegen_ssa::common::AtomicRmwBinOp) -> Self {
    //     match op {
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicXchg => AtomicRmwBinOp::AtomicXchg,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicAdd => AtomicRmwBinOp::AtomicAdd,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicSub => AtomicRmwBinOp::AtomicSub,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicAnd => AtomicRmwBinOp::AtomicAnd,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicNand => AtomicRmwBinOp::AtomicNand,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicOr => AtomicRmwBinOp::AtomicOr,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicXor => AtomicRmwBinOp::AtomicXor,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicMax => AtomicRmwBinOp::AtomicMax,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicMin => AtomicRmwBinOp::AtomicMin,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicUMax => AtomicRmwBinOp::AtomicUMax,
    //         pan_codegen_ssa::common::AtomicRmwBinOp::AtomicUMin => AtomicRmwBinOp::AtomicUMin,
    //     }
    // }
}
...
impl AtomicOrdering {
    // pub fn from_generic(ao: pan_codegen_ssa::common::AtomicOrdering) -> Self {
    //     match ao {
    //         pan_codegen_ssa::common::AtomicOrdering::NotAtomic => AtomicOrdering::NotAtomic,
    //         pan_codegen_ssa::common::AtomicOrdering::Unordered => AtomicOrdering::Unordered,
    //         pan_codegen_ssa::common::AtomicOrdering::Monotonic => AtomicOrdering::Monotonic,
    //         pan_codegen_ssa::common::AtomicOrdering::Acquire => AtomicOrdering::Acquire,
    //         pan_codegen_ssa::common::AtomicOrdering::Release => AtomicOrdering::Release,
    //         pan_codegen_ssa::common::AtomicOrdering::AcquireRelease => {
    //             AtomicOrdering::AcquireRelease
    //         }
    //         pan_codegen_ssa::common::AtomicOrdering::SequentiallyConsistent => {
...
impl SynchronizationScope {
    // pub fn from_generic(sc: pan_codegen_ssa::common::SynchronizationScope) -> Self {
    //     match sc {
    //         pan_codegen_ssa::common::SynchronizationScope::SingleThread => {
    //             SynchronizationScope::SingleThread
    //         }
    //         pan_codegen_ssa::common::SynchronizationScope::CrossThread => {
...
impl AsmDialect {
    // pub fn from_generic(asm: pan_ast::LlvmAsmDialect) -> Self {
    //     match asm {
    //         pan_ast::LlvmAsmDialect::Att => AsmDialect::Att,
    //         pan_ast::LlvmAsmDialect::Intel => AsmDialect::Intel,
    //     }
    // }
}
...
pub mod debuginfo {
    ...
    impl DebugEmissionKind {
        // pub fn from_generic(kind: pan_session::config::DebugInfo) -> Self {
        //     use pan_session::config::DebugInfo;
        //     match kind {
...
extern "C" {
    ...
    pub fn LLVMMDNodeInContext<'a>(C: &'a Context, Vals: *const &'a Value, Count: c_uint) -> &'a Value;
    ...
    pub fn LLVMBuildLoad<'a>(B: &Builder<'a>, PointerVal: &'a Value, Name: *const c_char) -> &'a Value;

    pub fn LLVMBuildStore<'a>(B: &Builder<'a>, Val: &'a Value, Ptr: &'a Value) -> &'a Value;

    pub fn LLVMBuildGEP<'a>(
        B: &Builder<'a>,
        Pointer: &'a Value,
    ...
    pub fn LLVMRustGetInstrProfIncrementIntrinsic<'a>(M: &Module) -> &'a Value;
    ...
    pub fn LLVMRustBuildVectorReduceFMin<'a>(B: &Builder<'a>, Src: &'a Value, IsNaN: bool)
                                         -> &'a Value;
    pub fn LLVMRustBuildVectorReduceFMax<'a>(B: &Builder<'a>, Src: &'a Value, IsNaN: bool)
                                         -> &'a Value;
    ...
    pub fn LLVMGetSections<'a>(ObjFile: &'a ObjectFile) -> &'a mut SectionIterator<'a>;
    /// Destroys a section iterator.
    pub fn LLVMDisposeSectionIterator<'a>(SI: &'a mut SectionIterator<'a>);
    /// Returns `true` if the section iterator is at the end of the section
    /// list:
    pub fn LLVMIsSectionIteratorAtEnd<'a>(ObjFile: &'a ObjectFile, SI: &SectionIterator<'a>) -> Bool;
    /// Moves the section iterator to point to the next section.
    pub fn LLVMMoveToNextSection<'a>(SI: &SectionIterator<'_>);
    ...
    pub fn LLVMRustCoverageCreatePGOFuncNameVar<'a>(F: &'a Value, FuncName: *const c_char)
                                                -> &'a Value;
    ...
    pub fn LLVMRustDIBuilderCreate<'a>(M: &'a Module) -> &'a mut DIBuilder<'a>;
    ...
    pub fn LLVMRustArchiveIteratorNew<'a>(AR: &'a Archive) -> &'a mut ArchiveIterator<'a>;
    ...
    pub fn LLVMRustLinkerNew<'a>(M: &'a Module) -> &'a mut Linker<'a>;
